...
/**
 * This class handles following admin commands: - itemcreate = show menu - create_item <id> [num] =
 * creates num items with respective id, if num is not specified, assumes 1.
 */
@Service
