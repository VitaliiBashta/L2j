...
public class AdminFightCalculator implements IAdminCommandHandler {
  ...
  private void handleShow(String params, L2PcInstance activeChar) {
    ...
    final StringBuilder replyMSG =
        StringUtil.startAppend(
            1000, "<html><title>Selected mobs to fight</title>" + "<body>" + "<table>");
    ...
    if (params.length() == 0) {
      ...
      StringUtil.append(
          ...
          ((L2NpcTemplate) npc1.getTemplate()).getName(),
          "</td><td width=70>",
          ((L2NpcTemplate) npc2.getTemplate()).getName(),
          "</td></tr>");
    }
    ...
    if ((tdmg2 - hp1) > 1) {
      StringUtil.append(
          replyMSG, "<td>", String.valueOf((int) ((100 * maxHp1) / (tdmg2 - hp1))), " sec</td>");
    } else {
    ...
    if ((tdmg1 - hp2) > 1) {
      StringUtil.append(
          replyMSG, "<td>", String.valueOf((int) ((100 * maxHp2) / (tdmg1 - hp2))), " sec</td>");
    } else {
      replyMSG.append("<td>never</td>");
    }
    ...
    if (params.length() == 0) {
      ...
      StringUtil.append(
          ...
          String.valueOf(((L2NpcTemplate) npc1.getTemplate()).getId()),
          " ",
          String.valueOf(((L2NpcTemplate) npc2.getTemplate()).getId()),
          "\"  width=100 height=15 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\">");
    }
