...
public class GrandBossTeleporters extends AbstractNpcAI {
  ...
  public String onTalk(L2Npc npc, L2PcInstance player) {
    ...
    switch (npc.getId()) {
            ...
            if ((status == 0) || (status == 1)) {
              if (playerCount >= 200) {
                ...
                player.teleToLocation(
                    TELEPORT_INTO_VALAKAS_LAIR.getX() + getRandom(600),
                    TELEPORT_INTO_VALAKAS_LAIR.getY() + getRandom(600),
                    TELEPORT_INTO_VALAKAS_LAIR.getZ());
      ...
      case 31759:
        {
          player.teleToLocation(
              TELEPORT_OUT_OF_VALAKAS_LAIR.getX() + getRandom(500),
              TELEPORT_OUT_OF_VALAKAS_LAIR.getY() + getRandom(500),
              TELEPORT_OUT_OF_VALAKAS_LAIR.getZ());
          break;
        }
    }
    return htmltext;
  ...
  private Quest valakasAI() {
    return questManager.getQuest(Valakas.class.getSimpleName());
  }
}
