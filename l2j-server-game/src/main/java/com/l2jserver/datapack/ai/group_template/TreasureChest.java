...
public class TreasureChest extends AbstractNpcAI {
  ...
  private static final SkillHolder[] TREASURE_BOMBS =
      new SkillHolder[] {
  ...
  static {
    ...
    DROPS.put(
        ...
        Arrays.asList( // Treasure Chest
            ...
            new ItemChanceHolder(
                21182, 5786, 1), // Transformation Scroll: Saber Tooth Tiger - Event
    ...
    DROPS.put(
        ...
        Arrays.asList( // Treasure Chest
            ...
            new ItemChanceHolder(
                21182, 7294, 1), // Transformation Scroll: Saber Tooth Tiger - Event
    ...
    DROPS.put(
        ...
        Arrays.asList( // Treasure Chest
            ...
            new ItemChanceHolder(
                21182, 8070, 1), // Transformation Scroll: Saber Tooth Tiger - Event
  ...
  public String onAttack(
    ...
    if (npc.getVariables().getInt("MAESTRO_SKILL_USED") == 0) {
      if ((skill != null) && (skill.getId() == MAESTROS_KEY_SKILL_ID)) {
        ...
        if ((npc.getLevel() - npc.getVariables().getInt("MAX_LEVEL_DIFFERENCE"))
            > attacker.getLevel()) {
        ...
        if (getRandom(100) < 30) {
          attacker.sendPacket(
              SystemMessageId.IF_YOU_HAVE_A_MAESTROS_KEY_YOU_CAN_USE_IT_TO_OPEN_THE_TREASURE_CHEST);
        }
      }
    }
