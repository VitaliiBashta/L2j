      ...
      case "TeleportIn":
        {
          ...
          final int sealOfAvariceOwner =
              SevenSigns.getInstance().getSealOwner(SevenSigns.SEAL_AVARICE);
          ...
          } else if ((compWinner == SevenSigns.CABAL_DAWN)
              && (playerCabal == SevenSigns.CABAL_DAWN)
              && (sealOfAvariceOwner == SevenSigns.CABAL_DAWN)) {
