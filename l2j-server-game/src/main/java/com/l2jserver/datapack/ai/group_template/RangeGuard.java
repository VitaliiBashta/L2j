...
@Service
public class RangeGuard extends AbstractNpcAI {
  // Skill
  private static final SkillHolder ULTIMATE_DEFENSE =
      new SkillHolder(5044, 3); // NPC Ultimate Defense
  ...
  public RangeGuard(NpcData npcData) {
    super(RangeGuard.class.getSimpleName(), "ai/group_template");

    for (L2NpcTemplate template : npcData.getAllNpcOfClassType("L2Monster")) {
