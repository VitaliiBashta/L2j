...
public class FeedableBeasts extends AbstractNpcAI {
  ...
  private static final int[] FEEDABLE_BEASTS = {
    ...
    21827, 21828, 21829, TRAINED_BUFFALO1, TRAINED_BUFFALO2, TRAINED_COUGAR1, TRAINED_COUGAR2,
  ...
  private final Q00655_AGrandPlanForTamingWildBeasts q00655_AGrandPlanForTamingWildBeasts;

  public FeedableBeasts(Q00655_AGrandPlanForTamingWildBeasts q00655_aGrandPlanForTamingWildBeasts) {
    super(FeedableBeasts.class.getSimpleName(), "ai/group_template");
    q00655_AGrandPlanForTamingWildBeasts = q00655_aGrandPlanForTamingWildBeasts;
    ...
    if (Util.contains(TAMED_BEASTS, nextNpcId)) {
      ...
      final L2TamedBeastInstance nextNpc =
          new L2TamedBeastInstance(
              nextNpcId, player, food - FOODSKILLDIFF, npc.getX(), npc.getY(), npc.getZ());
      nextNpc.setRunning();
