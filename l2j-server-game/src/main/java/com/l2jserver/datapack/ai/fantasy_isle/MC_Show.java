      ...
      if (event.equalsIgnoreCase("6")) {
        ...
        switch (npc.getId()) {
          case 32433:
            ...
            npc.getAI()
                .setIntention(
                    CtrlIntention.AI_INTENTION_MOVE_TO, new Location(-56698, -56430, -2008, 32768));
          ...
          default:
            ...
            npc.getAI()
                .setIntention(
                    CtrlIntention.AI_INTENTION_MOVE_TO, new Location(-56594, -56064, -2008, 32768));
            break;
        }
        ...
        switch (npc.getId()) {
          ...
          default:
            npc.getAI()
                .setIntention(
                    CtrlIntention.AI_INTENTION_MOVE_TO, new Location(-56343, -56330, -2008, 32768));
            break;
        }
