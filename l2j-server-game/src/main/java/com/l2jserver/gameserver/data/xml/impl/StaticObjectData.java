...
public class StaticObjectData implements IXmlReader {
  ...
  public void load() {
    ...
    LOG.info("Loaded {} static object templates.", staticObjects.size());
  }
  ...
  private void addObject(StatsSet set) {
    L2StaticObjectInstance obj =
        new L2StaticObjectInstance(new L2CharTemplate(new StatsSet()), set.getInt("id"));
    ...
    staticObjects.put(obj.getObjectId(), obj);
  }
