...
public final class SystemMessageId {
  ...
  public static final SystemMessageId S1_HAS_INVITED_YOU_TO_JOIN_THE_CLAN_S2 =
      new SystemMessageId(67);
  /**
   * ID: 68<br>
   * Message: Would you like to withdraw from clan $s1? If you leave, you will have to wait at least
   * a day before joining another clan.
   */
  public static final SystemMessageId WOULD_YOU_LIKE_TO_WITHDRAW_FROM_THE_S1_CLAN =
      new SystemMessageId(68);
  /**
   * ID: 69<br>
   * Message: Would you like to dismiss $s1 from the clan? If you do so, you will have to wait at
   * least a day before accepting a new member.
   */
  public static final SystemMessageId WOULD_YOU_LIKE_TO_DISMISS_S1_FROM_THE_CLAN =
      new SystemMessageId(69);
  /**
   * ID: 70<br>
  ...
  /**
   * ID: 77<br>
   * Message: You cannot create another character. Please delete an existing character and try
   * again.
   */
  public static final SystemMessageId CANNOT_CREATE_CHARACTER = new SystemMessageId(77);
  /**
   * ID: 78<br>
   * Message: When you delete a character, any items in his/her possession will also be deleted. Do
   * you really wish to delete $s1?
   */
  ...
  /**
   * ID: 141<br>
   * Message: Once a trade is confirmed, the items involved cannot be moved again. If you wish to
   * make a change, cancel the trade and start again.
   */
  public static final SystemMessageId ONCE_THE_TRADE_IS_CONFIRMED_THE_ITEM_CANNOT_BE_MOVED_AGAIN =
      new SystemMessageId(141);
  /**
   * ID: 142<br>
  ...
  /**
   * ID: 199<br>
   * Message: You have recently been dismissed from a clan. You are not allowed to join another clan
   * for 24-hours.
   */
  ...
  public static final SystemMessageId YOU_MUST_WAIT_XX_DAYS_BEFORE_CREATING_A_NEW_CLAN =
      new SystemMessageId(230);
  /**
   * ID: 231<br>
   * Message: After a clan member is dismissed from a clan, the clan must wait at least a day before
   * accepting a new member.
   */
  public static final SystemMessageId YOU_MUST_WAIT_BEFORE_ACCEPTING_A_NEW_MEMBER =
      new SystemMessageId(231);
  /**
   * ID: 232<br>
   * Message: After leaving or having been dismissed from a clan, you must wait at least a day
   * before joining another clan.
   */
  public static final SystemMessageId YOU_MUST_WAIT_BEFORE_JOINING_ANOTHER_CLAN =
      new SystemMessageId(232);
  /**
   * ID: 233<br>
   * Message: The Academy/Royal Guard/Order of Knights is full and cannot accept new members at this
   * time.
   */
  ...
  /**
   * ID: 247<br>
   * Message: You have already been at war with the $s1 clan: 5 days must pass before you can
   * challenge this clan again.
   */
  public static final SystemMessageId FIVE_DAYS_MUST_PASS_BEFORE_CHALLENGE_AGAIN =
      new SystemMessageId(247);
  /**
   * ID: 248<br>
  ...
  /**
   * ID: 250<br>
   * Message: You have personally surrendered to the $s1 clan. You are no longer participating in
   * this clan war.
   */
  public static final SystemMessageId YOU_HAVE_PERSONALLY_SURRENDERED_TO_THE_S1_CLAN =
      new SystemMessageId(250);
  /**
   * ID: 251<br>
  ...
  /**
   * ID: 260<br>
   * Message: The clan reputation score was reduced because it hasn't been 5 days since refusing a
   * clan war.
   */
  public static final SystemMessageId FIVE_DAYS_NOT_PASSED_SINCE_YOU_WERE_REFUSED_WAR =
      new SystemMessageId(260);
  /**
   * ID: 261<br>
  ...
  /**
   * ID: 294<br>
   * Message: You cannot summon the encampment because you are not a member of the siege clan
   * involved in the castle / fortress / hideout siege.
   */
  ...
  /**
   * ID: 337<br>
   * Message: The soulshot you are attempting to use does not match the grade of your equipped
   * weapon.
   */
  ...
  /**
   * ID: 456<br>
   * Message: Lineage II game services may be used by individuals 15 years of age or older except
   * for PvP servers, which may only be used by adults 18 years of age and older. (Korea Only)
   */
  ...
  /**
   * ID: 468<br>
   * Message: A clan that has withdrawn or been expelled cannot enter into an alliance within one
   * day of withdrawal or expulsion.
   */
  public static final SystemMessageId CANT_ENTER_ALLIANCE_WITHIN_1_DAY = new SystemMessageId(468);
  /**
   * ID: 469<br>
   * Message: You may not ally with a clan you are currently at war with. That would be diabolical
   * and treacherous.
   */
  ...
  /**
   * ID: 514<br>
   * Message: Do you really wish to dissolve the alliance? You cannot create a new alliance for 1
   * day.
   */
  ...
  public static final SystemMessageId YOU_MAY_NOT_CREATE_ALLY_WHILE_DISSOLVING =
      new SystemMessageId(550);
  /**
   * ID: 551<br>
   * Message: As you are currently schedule for clan dissolution, your clan level cannot be
   * increased.
   */
  public static final SystemMessageId CANNOT_RISE_LEVEL_WHILE_DISSOLUTION_IN_PROGRESS =
      new SystemMessageId(551);
  /**
   * ID: 552<br>
   * Message: As you are currently schedule for clan dissolution, you cannot register or delete a
   * Clan Crest.
   */
  public static final SystemMessageId CANNOT_SET_CREST_WHILE_DISSOLUTION_IN_PROGRESS =
      new SystemMessageId(552);
  /**
   * ID: 553<br>
  ...
  public static final SystemMessageId NAMING_PETNAME_CONTAINS_INVALID_CHARS =
      new SystemMessageId(591);
  /**
   * ID: 592<br>
   * Message: Do you wish to dismiss your pet? Dismissing your pet will cause the pet necklace to
   * disappear.
   */
   ...
   */
  public static final SystemMessageId YOU_CAN_ONLY_ENTER_UP_128_NAMES_IN_YOUR_FRIENDS_LIST =
      new SystemMessageId(605);
  /**
   * ID: 606<br>
   * Message: The Friend's List of the person you are trying to add is full, so registration is not
   * possible.
   */
  public static final SystemMessageId
      THE_FRIENDS_LIST_OF_THE_PERSON_YOU_ARE_TRYING_TO_ADD_IS_FULL_SO_REGISTRATION_IS_NOT_POSSIBLE =
          new SystemMessageId(606);
  /**
   * ID: 607<br>
   * Message: You do not have any further skills to learn. Come back when you have reached Level
   * $s1.
   */
  public static final SystemMessageId DO_NOT_HAVE_FURTHER_SKILLS_TO_LEARN_S1 =
      new SystemMessageId(607);
  /**
   * ID: 608<br>
  ...
  /**
   * ID: 639<br>
   * Message: Your application has been denied because you have already submitted a request for
   * another Castle Siege.
   */
  public static final SystemMessageId
      APPLICATION_DENIED_BECAUSE_ALREADY_SUBMITTED_A_REQUEST_FOR_ANOTHER_SIEGE_BATTLE =
          new SystemMessageId(639);
  /**
   * ID: 640<br>
  ...
  public static final SystemMessageId FAILED_TO_APPROVE_CASTLE_DEFENSE_AID =
      new SystemMessageId(641);
  /**
   * ID: 642<br>
   * Message: You are already registered to the attacker side and must cancel your registration
   * before submitting your request.
   */
  public static final SystemMessageId ALREADY_ATTACKER_NOT_CANCEL = new SystemMessageId(642);
  /**
   * ID: 643<br>
   * Message: You have already registered to the defender side and must cancel your registration
   * before submitting your request.
   */
  ...
  public static final SystemMessageId
      POSITIONING_CANNOT_BE_DONE_BECAUSE_DISTANCE_BETWEEN_MERCENARIES_TOO_SHORT =
          new SystemMessageId(657);
  /**
   * ID: 658<br>
   * Message: This is not a mercenary of a castle that you own and so you cannot cancel its
   * positioning.
   */
  public static final SystemMessageId
      THIS_IS_NOT_A_MERCENARY_OF_A_CASTLE_THAT_YOU_OWN_AND_SO_CANNOT_CANCEL_POSITIONING =
          new SystemMessageId(658);
  /**
   * ID: 659<br>
   * Message: This is not the time for siege registration and so registrations cannot be accepted or
   * rejected.
   */
  public static final SystemMessageId NOT_SIEGE_REGISTRATION_TIME1 = new SystemMessageId(659);
  /**
   * ID: 660<br>
   * Message: This is not the time for siege registration and so registration and cancellation
   * cannot be done.
   */
  ...
  public static final SystemMessageId THE_PLAYER_IS_REJECTING_FRIEND_INVITATIONS =
      new SystemMessageId(662);
  /**
   * ID: 663<br>
   * Message: The siege time has been declared for $s. It is not possible to change the time after a
   * siege time has been declared. Do you want to continue?
   */
  ...
  /**
   * ID: 669<br>
   * Message: You are canceling your application to participate in the $s1 castle siege. Do you want
   * to continue?
   */
  ...
  /**
   * ID: 673<br>
   * Message: Only a clan leader whose clan is of level 2 or higher is allowed to participate in a
   * clan hall auction.
   */
  ...
  /**
   * ID: 676<br>
   * Message: Since you have already submitted a bid, you are not allowed to participate in another
  ...
  public static final SystemMessageId CLAN_THAT_OWNS_CASTLE_CANNOT_PARTICIPATE_OTHER_SIEGE =
      new SystemMessageId(689);
  /**
   * ID: 690<br>
   * Message: You cannot register as an attacker because you are in an alliance with the
   * castle-owning clan.
   */
  ...
  /**
   * ID: 702<br>
   * Message: There are no GMs currently visible in the public list as they may be performing other
   ...
   */
  public static final SystemMessageId YOU_CAN_ONLY_ENTER_UP_TO_128_NAMES_IN_YOUR_BLOCK_LIST =
      new SystemMessageId(706);
  /**
   * ID: 707<br>
  ...
  /**
   * ID: 720<br>
   * Message: The purchase price is higher than the amount of money that you have and so you cannot
   * open a personal store.
   */
  public static final SystemMessageId THE_PURCHASE_PRICE_IS_HIGHER_THAN_MONEY =
      new SystemMessageId(720);
  /**
   * ID: 721<br>
  ...
  /**
   * ID: 722<br>
   * Message: You cannot dissolve an alliance while an affiliated clan is participating in a siege
   * battle.
   */
  public static final SystemMessageId CANNOT_DISSOLVE_ALLY_WHILE_IN_SIEGE =
      new SystemMessageId(722);
  /**
   * ID: 723<br>
  ...
  /**
   * ID: 728<br>
   * Message: You cannot apply for dissolution again within seven days after a previous application
   * for dissolution.
   */
  ...
  /**
   * ID: 733<br>
   * Message: We have received $s1 petitions from you today and that is the maximum that you can
   * submit in one day. You cannot submit any more petitions.
   */
  public static final SystemMessageId WE_HAVE_RECEIVED_S1_PETITIONS_TODAY =
      new SystemMessageId(733);
  /**
   * ID: 734<br>
   * Message: You have failed at submitting a petition on behalf of someone else. $c1 already
   * submitted a petition.
   */
  public static final SystemMessageId PETITION_FAILED_C1_ALREADY_SUBMITTED =
      new SystemMessageId(734);
  /**
   * ID: 735<br>
  ...
  /**
   * ID: 741<br>
   * Message: You have failed at adding $c1 to the petition chat. Petition has already been
   * submitted.
   */
  ...
  /**
   * ID: 751<br>
   * Message: As there is a conflict in the siege relationship with a clan in the alliance, you
   * cannot invite that clan to the alliance.
   */
  ...
  public static final SystemMessageId S1_MINUTES_LEFT_THIS_WEEKS_PLAY_TIME =
      new SystemMessageId(759);
  /**
   * ID: 760<br>
   * Message: $c1 cannot join the clan because one day has not yet passed since they left another
   * clan.
   */
  public static final SystemMessageId C1_MUST_WAIT_BEFORE_JOINING_ANOTHER_CLAN =
      new SystemMessageId(760);
  /**
   * ID: 761<br>
   * Message: $s1 clan cannot join the alliance because one day has not yet passed since they left
   * another alliance.
   */
  public static final SystemMessageId S1_CANT_ENTER_ALLIANCE_WITHIN_1_DAY =
      new SystemMessageId(761);
  /**
   * ID: 762<br>
  ...
  /**
   * ID: 769<br>
   * Message: A hacking tool has been discovered. Please try playing again after closing unnecessary
   * programs.
   */
  ...
  /**
   * ID: 777<br>
   * Message: The clan hall which had been put up for auction was not sold and therefore has been
   * re-listed.
   */
  ...
  /**
   * ID: 802<br>
   * Message: Petitions are not being accepted at this time. You may submit your petition after $s1
   * a.m./p.m.
   */
  ...
  /**
   * ID: 826<br>
   * Message: First prize goes to the player in lane $s1. Second prize goes to the player in lane
   * $s2.
   */
  ...
  /**
   * ID: 833<br>
   * Message: You are not authorized to make further recommendations at this time. You will receive
   * more recommendation credits each day at 1 p.m.
   */
  ...
  public static final SystemMessageId YOU_MAY_NOT_THROW_THE_DICE_AT_THIS_TIME_TRY_AGAIN_LATER =
      new SystemMessageId(835);
  /**
   * ID: 836<br>
   * Message: You have exceeded your inventory volume limit and cannot take this item.
   */
  public static final SystemMessageId
      YOU_HAVE_EXCEEDED_YOUR_INVENTORY_VOLUME_LIMIT_AND_CANNOT_TAKE_THIS_ITEM =
          new SystemMessageId(836);
  /**
   * ID: 837<br>
   ...
   * removed, the prohibition time will increase even further.
   */
  ...
  /**
   * ID: 1039<br>
   * Message: Items left at the clan hall warehouse can only be retrieved by the clan leader. Do you
   * want to continue?
   */
  public static final SystemMessageId ONLY_CLAN_LEADER_CAN_RETRIEVE_ITEMS_FROM_CLAN_WAREHOUSE =
      new SystemMessageId(1039);
  /**
   * ID: 1040<br>
   * Message: Dimensional Items sent that way can be retrieved from any Dimensional Merchant in all
   * regions. Do you wish to continue?
   */
  public static final SystemMessageId ITEMS_SENT_BY_FREIGHT_PICKED_UP_FROM_ANYWHERE =
      new SystemMessageId(1040);
  /**
   * ID: 1041<br>
  ...
  /**
   * ID: 1049<br>
   * Message: While 'blocking' everything, it is not possible to send invitations for organizing
   * parties.
   */
  public static final SystemMessageId NO_PARTY_WHEN_BLOCKING = new SystemMessageId(1049);
  /**
   * ID: 1050<br>
   * Message: There are no communities in my clan. Clan communities are allowed for clans with skill
   * levels of 2 and higher.
   */
  public static final SystemMessageId NO_CB_IN_MY_CLAN = new SystemMessageId(1050);
  /**
   * ID: 1051<br>
   * Message: Payment for your clan hall has not been made. Please make payment to your clan
   * warehouse by $s1 tomorrow.
   */
  public static final SystemMessageId
  ...
  /**
   * ID: 1052<br>
   * Message: The clan hall fee is one week overdue; therefore the clan hall ownership has been
   * revoked.
   */
  public static final SystemMessageId
  ...
  /**
   * ID: 1065<br>
   * Message: While operating a private store or workshop, you cannot discard, destroy, or trade an
   * item.
   */
  public static final SystemMessageId CANNOT_TRADE_DISCARD_DROP_ITEM_WHILE_IN_SHOPMODE =
      new SystemMessageId(1065);
  /**
   * ID: 1066<br>
  ...
  /**
   * ID: 1077<br>
   * Message: A GameGuard Execution error has occurred. Please send the *.erl file(s) located in the
   * GameGuard folder to game@inca.co.kr.
   */
  public static final SystemMessageId GG_EXECUTION_ERROR = new SystemMessageId(1077);
  /**
   * ID: 1078<br>
   * Message: When a user's keyboard input exceeds a certain cumulative score a chat ban will be
   * applied. This is done to discourage spamming. Please avoid posting the same message multiple
  ...
  /**
   * ID: 1112<br>
   * Message: The prize amount for the winner of Lottery #$s1 is $s2 adena. We have $s3 first prize
   * winners.
   */
  public static final SystemMessageId AMOUNT_FOR_WINNER_S1_IS_S2_ADENA_WE_HAVE_S3_PRIZE_WINNER =
      new SystemMessageId(1112);
  /**
   * ID: 1113<br>
   * Message: The prize amount for Lucky Lottery #$s1 is $s2 adena. There was no first prize winner
   * in this drawing, therefore the jackpot will be added to the next drawing.
   */
  public static final SystemMessageId AMOUNT_FOR_LOTTERY_S1_IS_S2_ADENA_NO_WINNER =
      new SystemMessageId(1113);
  /**
   * ID: 1114<br>
   * Message: Your clan may not register to participate in a siege while under a grace period of the
   * clan's dissolution.
   */
  public static final SystemMessageId CANT_PARTICIPATE_IN_SIEGE_WHILE_DISSOLUTION_IN_PROGRESS =
      new SystemMessageId(1114);
  /**
   * ID: 1115<br>
  ...
  public static final SystemMessageId CLAN_MEMBER_CANNOT_BE_DISMISSED_DURING_COMBAT =
      new SystemMessageId(1117);
  /**
   * ID: 1118<br>
   * Message: Unable to process this request until your inventory's weight and slot count are less
   * than 80 percent of capacity.
   */
  public static final SystemMessageId INVENTORY_LESS_THAN_80_PERCENT = new SystemMessageId(1118);
  /**
   * ID: 1119<br>
   * Message: Quest was automatically canceled when you attempted to settle the accounts of your
   * quest while your inventory exceeded 80 percent of capacity.
   */
  public static final SystemMessageId QUEST_CANCELED_INVENTORY_EXCEEDS_80_PERCENT =
      new SystemMessageId(1119);
  /**
   * ID: 1120<br>
  ...
  /**
   * ID: 1135<br>
   * Message: While you are engaged in combat, you cannot operate a private store or private
   * workshop.
   */
  public static final SystemMessageId CANT_OPERATE_PRIVATE_STORE_DURING_COMBAT =
      new SystemMessageId(1135);
  /**
   * ID: 1136<br>
   * Message: Since there was an account that used this IP and attempted to log in illegally, this
   * account is not allowed to connect to the game server for $s1 minutes. Please use another game
   * server.
   */
  ...
  /**
   * ID: 1143<br>
   * Message: Since you do not have enough items to maintain the servitor's stay, the servitor has
   * disappeared.
   */
  public static final SystemMessageId SERVITOR_DISAPPEARED_NOT_ENOUGH_ITEMS =
      new SystemMessageId(1143);
  /**
   * ID: 1144<br>
  ...
  public static final SystemMessageId S2_S3_PURCHASED_FROM_C1_FOR_S4_ADENA =
      new SystemMessageId(1156);
  /**
   * ID: 1157<br>
   * Message: The preview state only lasts for 5 seconds. If you wish to continue, please click
   * Confirm.
   */
  ...
  /**
   * ID: 1159<br>
   * Message: The ferry from Talking Island will arrive at Gludin Harbor in approximately 10
   * minutes.
   */
  public static final SystemMessageId FERRY_FROM_TALKING_ARRIVE_AT_GLUDIN_10_MINUTES =
      new SystemMessageId(1159);
  /**
   * ID: 1160<br>
   * Message: The ferry from Talking Island will be arriving at Gludin Harbor in approximately 5
   * minutes.
   */
  public static final SystemMessageId FERRY_FROM_TALKING_ARRIVE_AT_GLUDIN_5_MINUTES =
      new SystemMessageId(1160);
  /**
   * ID: 1161<br>
   * Message: The ferry from Talking Island will be arriving at Gludin Harbor in approximately 1
   * minute.
   */
  public static final SystemMessageId FERRY_FROM_TALKING_ARRIVE_AT_GLUDIN_1_MINUTE =
      new SystemMessageId(1161);
  /**
   * ID: 1162<br>
   * Message: The ferry from Giran Harbor will be arriving at Talking Island in approximately 15
   * minutes.
   */
  public static final SystemMessageId FERRY_FROM_GIRAN_ARRIVE_AT_TALKING_15_MINUTES =
      new SystemMessageId(1162);
  /**
   * ID: 1163<br>
   * Message: The ferry from Giran Harbor will be arriving at Talking Island in approximately 10
   * minutes.
   */
  public static final SystemMessageId FERRY_FROM_GIRAN_ARRIVE_AT_TALKING_10_MINUTES =
      new SystemMessageId(1163);
  /**
   * ID: 1164<br>
   * Message: The ferry from Giran Harbor will be arriving at Talking Island in approximately 5
   * minutes.
   */
  public static final SystemMessageId FERRY_FROM_GIRAN_ARRIVE_AT_TALKING_5_MINUTES =
      new SystemMessageId(1164);
  /**
   * ID: 1165<br>
   * Message: The ferry from Giran Harbor will be arriving at Talking Island in approximately 1
   * minute.
   */
  public static final SystemMessageId FERRY_FROM_GIRAN_ARRIVE_AT_TALKING_1_MINUTE =
      new SystemMessageId(1165);
  /**
   * ID: 1166<br>
   * Message: The ferry from Talking Island will be arriving at Giran Harbor in approximately 20
   * minutes.
   */
  public static final SystemMessageId FERRY_FROM_TALKING_ARRIVE_AT_GIRAN_20_MINUTES =
      new SystemMessageId(1166);
  /**
   * ID: 1167<br>
   * Message: The ferry from Talking Island will be arriving at Giran Harbor in approximately 15
   * minutes.
   */
  public static final SystemMessageId FERRY_FROM_TALKING_ARRIVE_AT_GIRAN_15_MINUTES =
      new SystemMessageId(1167);
  /**
   * ID: 1168<br>
   * Message: The ferry from Talking Island will be arriving at Giran Harbor in approximately 10
   * minutes.
   */
  public static final SystemMessageId FERRY_FROM_TALKING_ARRIVE_AT_GIRAN_10_MINUTES =
      new SystemMessageId(1168);
  /**
   * ID: 1169<br>
   * Message: The ferry from Talking Island will be arriving at Giran Harbor in approximately 5
   * minutes.
   */
  public static final SystemMessageId FERRY_FROM_TALKING_ARRIVE_AT_GIRAN_5_MINUTES =
      new SystemMessageId(1169);
  /**
   * ID: 1170<br>
   * Message: The ferry from Talking Island will be arriving at Giran Harbor in approximately 1
   * minute.
   */
  public static final SystemMessageId FERRY_FROM_TALKING_ARRIVE_AT_GIRAN_1_MINUTE =
      new SystemMessageId(1170);
  /**
   * ID: 1171<br>
  ...
  /**
   * ID: 1178<br>
   * Message: This seal permits the group that holds it to exclusive entry to the dungeons opened by
   * the Seal of Avarice during the seal validation period. It also permits trading with the
   * Merchant of Mammon and permits meetings with Anakim or Lilith in the Disciple's Necropolis.
   */
  public static final SystemMessageId AVARICE_DESCRIPTION = new SystemMessageId(1178);
  /**
   * ID: 1179<br>
   * Message: This seal permits the group that holds it to enter the dungeon opened by the Seal of
   * Gnosis, use the teleportation service offered by the priest in the village, and do business
   * with the Blacksmith of Mammon. The Orator of Revelations appears and casts good magic on the
   * winners, and the Preacher of Doom appears and casts bad magic on the losers.
   */
  public static final SystemMessageId GNOSIS_DESCRIPTION = new SystemMessageId(1179);
  /**
   * ID: 1180<br>
   * Message: During the Seal Validation period, the cabal's maximum CP amount increases. In
   * addition, the cabal possessing the seal will benefit from favorable changes in the cost to
   * upgrade castle defense mercenaries, castle gates and walls; basic P. Def. of castle gates and
   * walls; and the limit imposed on the castle tax rate. The use of siege war weapons will also be
   * limited. If the Revolutionary Army of Dusk takes possession of this seal during the castle
   * siege war, only the clan that owns the castle can come to its defense.
   */
  ...
  /**
   * ID: 1187<br>
   * Message: If you've forgotten your account information or password, please visit the Support
   * Center on the PlayNC website (http://us.ncsoft.com/support/).
   */
  public static final SystemMessageId ACCOUNT_INFORMATION_FORGOTTON_VISIT_WEBSITE =
      new SystemMessageId(1187);
  /**
   * ID: 1188<br>
  ...
  public static final SystemMessageId YOUR_TARGET_NO_LONGER_RECEIVE_A_RECOMMENDATION =
      new SystemMessageId(1188);
  /**
   * ID: 1189<br>
   * Message: The temporary alliance of the Castle Attacker team is in effect. It will be dissolved
   * when the Castle Lord is replaced.
   */
  ...
  /**
   * ID: 1191<br>
   * Message: The ferry from Gludin Harbor will be arriving at Talking Island in approximately 10
   * minutes.
   */
  public static final SystemMessageId FERRY_FROM_GLUDIN_ARRIVE_AT_TALKING_10_MINUTES =
      new SystemMessageId(1191);
  /**
   * ID: 1192<br>
   * Message: The ferry from Gludin Harbor will be arriving at Talking Island in approximately 5
   * minutes.
   */
  public static final SystemMessageId FERRY_FROM_GLUDIN_ARRIVE_AT_TALKING_5_MINUTES =
      new SystemMessageId(1192);
  /**
   * ID: 1193<br>
   * Message: The ferry from Gludin Harbor will be arriving at Talking Island in approximately 1
   * minute.
   */
  public static final SystemMessageId FERRY_FROM_GLUDIN_ARRIVE_AT_TALKING_1_MINUTE =
      new SystemMessageId(1193);
  /**
   * ID: 1194<br>
   * Message: A mercenary can be assigned to a position from the beginning of the Seal Validation
   * period until the time when a siege starts.
   */
  ...
  /**
   * ID: 1210<br>
   * Message: Seven Signs: The competition period has begun. Visit a Priest of Dawn or Priestess of
   * Dusk to participate in the event.
   */
  public static final SystemMessageId QUEST_EVENT_PERIOD_BEGUN = new SystemMessageId(1210);
  /**
   * ID: 1211<br>
   * Message: Seven Signs: The competition period has ended. The next quest event will start in one
   * week.
   */
  ...
  /**
   * ID: 1229<br>
   * Message: No more messages may be sent at this time. Each account is allowed 10 messages per
   * day.
   */
  ...
  /**
   * ID: 1238<br>
   * Message: Your temporary mailbox is full. No more mail can be stored; you have reached the 10
   * message limit.
   */
  ...
  /**
   * ID: 1242<br>
   * Message: Users who have not verified their age may not log in between the hours of 10:00 p.m.
   * and 6:00 a.m.
   */
  ...
  public static final SystemMessageId YOU_MAY_ONLY_RIDE_WYVERN_WHILE_RIDING_STRIDER =
      new SystemMessageId(1249);
  /**
   * ID: 1250<br>
   * Message: Do you really want to surrender? If you surrender during an alliance war, your Exp
   * will drop the same as if you were to die once.
   */
  ...
  /**
   * ID: 1253<br>
   * Message: Are you sure you want to surrender? Exp penalty will be the same as death and you will
   * not be allowed to participate in clan war.
   */
  ...
  /**
   * ID: 1261<br>
   * Message: Seven Signs: The quest event period has begun. Speak with a Priest of Dawn or Dusk
   * Priestess if you wish to participate in the event.
   */
  ...
  /**
   * ID: 1263<br>
   * Message: Seven Signs: This is the seal validation period. A new quest event period begins next
   * Monday.
   */
  ...
  /**
   * ID: 1271<br>
   * Message: Do you wish to participate? Until the next seal validation period, you will be a
   * member of the Lords of Dawn.
   */
  public static final SystemMessageId DAWN_CONFIRM = new SystemMessageId(1271);
  /**
   * ID: 1272<br>
   * Message: Do you wish to participate? Until the next seal validation period, you will be a
   * member of the Revolutionaries of Dusk.
   */
  ...
  /**
   * ID: 1289<br>
   * Message: Since the seal was owned during the previous period and 10% or more people have
   * participated.
   */
  ...
  /**
   * ID: 1291<br>
   * Message: Although the seal was owned during the previous period, less than 10% of people have
   * voted.
   */
  public static final SystemMessageId SEAL_OWNED_10_LESS_VOTED = new SystemMessageId(1291);
  /**
   * ID: 1292<br>
   * Message: Since the seal was not owned during the previous period, and since less than 35
   * percent of people have voted.
   */
  ...
  public static final SystemMessageId CAN_BE_USED_DURING_QUEST_EVENT_PERIOD =
      new SystemMessageId(1303);
  /**
   * ID: 1304<br>
   * Message: The influence of the Seal of Strife has caused all defensive registrations to be
   * canceled.
   */
  public static final SystemMessageId STRIFE_CANCELED_DEFENSIVE_REGISTRATION =
      new SystemMessageId(1304);
  /**
   * ID: 1305<br>
  ...
  /**
   * ID: 1309<br>
   * Message: To use this option, you must have the latest version of MSN Messenger installed on
   * your computer.
   */
  public static final SystemMessageId LATEST_MSN_REQUIRED = new SystemMessageId(1309);
  /**
   * ID: 1310<br>
   * Message: For full functionality, the latest version of MSN Messenger must be installed on your
   * computer.
   */
  public static final SystemMessageId LATEST_MSN_RECOMMENDED = new SystemMessageId(1310);
  /**
   * ID: 1311<br>
   * Message: Previous versions of MSN Messenger only provide the basic features for in-game MSN
   * Messenger chat. Add/Delete Contacts and other MSN Messenger options are not available.
   */
  ...
  /**
   * ID: 1313<br>
   * Message: $s1, to better server our customers, all chat histories are stored and maintained by
   * NCsoft. If you do not agree to have your chat records stored, please close the chat window now.
   * For more information regarding this procedure, please visit our home page at www.PlayNC.com.
   * Thank you!
   */
  ...
  /**
   * ID: 1315<br>
   * Message: Deleting a contact will remove that contact from MSN Messenger as well. The contact
   * can still check your online status and will not be blocked from sending you a message.
   */
  ...
  /**
   * ID: 1325<br>
   * Message: You've logged into another computer and have been logged out of the .NET Messenger
  ...
  /**
   * ID: 1333<br>
   * Message: The replay file is not accessible. Please verify that the replay.ini file exists in
   * your Lineage 2 directory. Please note that footage from previous major updates are not
   * accessible in newer updates.
   */
  ...
  /**
   * ID: 1343<br>
   * Message: Incorrect email address and/or password. Your attempt to log into .NET Messenger
   * Service has failed.
   */
  public static final SystemMessageId INCORRECT_ADDRESS_OR_PASSWORD = new SystemMessageId(1343);
  /**
   * ID: 1344<br>
   * Message: Your request to log into the .NET Messenger Service has failed. Please verify that you
  ...
  /**
   * ID: 1350<br>
   * Message: Your status will be changed to indicate that you are "off-line." All chat windows
   * currently open will be closed.
   */
  ...
  /**
   * ID: 1353<br>
   * Message: You can set the option to show your status as always being off-line to all of your
   * contacts.
   */
  public static final SystemMessageId CAN_SET_OPTION_TO_ALWAYS_SHOW_OFFLINE =
      new SystemMessageId(1353);
  /**
   * ID: 1354<br>
  ...
  public static final SystemMessageId S2_OF_S1_SURRENDERED_AS_INDIVIDUAL =
      new SystemMessageId(1365);
  /**
   * ID: 1366<br>
   * Message: In order to delete a group, you must not have any contacts listed under that group.
   * Please transfer your contact(s) to another group before continuing with deletion.
   */
  ...
  /**
   * ID: 1371<br>
   * Message: It has been determined that you're not engaged in normal gameplay and a restriction
   * has been imposed upon you. You may not move for $s1 minutes.
   */
  ...
  /**
   * ID: 1382<br>
   * Message: To fulfill the quest, you must bring the chosen weapon. Are you sure you want to
   * choose this weapon?
   */
  ...
  public static final SystemMessageId YOU_HAVE_FAILED_TO_TRANSFER_THE_PARTY_LEADER_RIGHTS =
      new SystemMessageId(1403);
  /**
   * ID: 1404<br>
   * Message: The owner of the private manufacturing store has changed the price for creating this
   * item. Please check the new price before trying again.
   */
  ...
  /**
   * ID: 1407<br>
   * Message: You are using a computer that does not allow you to log in with two accounts at the
   * same time.
   */
  public static final SystemMessageId NO_LOGIN_WITH_TWO_ACCOUNTS = new SystemMessageId(1407);
  /**
   * ID: 1408<br>
   * Message: Your prepaid remaining usage time is $s1 hours and $s2 minutes. You have $s3 paid
   * reservations left.
   */
  public static final SystemMessageId PREPAID_LEFT_S1_S2_S3 = new SystemMessageId(1408);
  /**
   * ID: 1409<br>
   * Message: Your prepaid usage time has expired. Your new prepaid reservation will be used. The
   * remaining usage time is $s1 hours and $s2 minutes.
   */
  public static final SystemMessageId PREPAID_EXPIRED_S1_S2 = new SystemMessageId(1409);
  /**
   * ID: 1410<br>
   * Message: Your prepaid usage time has expired. You do not have any more prepaid reservations
   * left.
   */
  ...
  /**
   * ID: 1414<br>
   * Message: The width and length should be 100 or more grids and less than 5000 grids
   * respectively.
   */
  ...
  /**
   * ID: 1437<br>
   * Message: Players are no longer allowed to play dice. Dice can no longer be purchased from a
   * village store. However, you can still sell them to any village store.
   */
  ...
  /**
   * ID: 1472<br>
   * Message: You look oddly at the fishing pole in disbelief and realize that you can't attack
   * anything with this.
   */
  ...
  public static final SystemMessageId YOU_WILL_ENTER_THE_OLYMPIAD_STADIUM_IN_S1_SECOND_S =
      new SystemMessageId(1492);
  /**
   * ID: 1493<br>
   * Message: Your opponent made haste with their tail between their legs; the match has been
   * cancelled.
   */
  public static final SystemMessageId
  ...
  /**
   * ID: 1494<br>
   * Message: Your opponent does not meet the requirements to do battle; the match has been
   * cancelled.
   */
  public static final SystemMessageId
  ...
  public static final SystemMessageId YOU_WILL_BE_MOVED_TO_TOWN_IN_S1_SECONDS =
      new SystemMessageId(1499);
  /**
   * ID: 1500<br>
   * Message: $c1 does not meet the participation requirements. A subclass character cannot
   * participate in the Olympiad.
   */
  public static final SystemMessageId C1_CANT_JOIN_THE_OLYMPIAD_WITH_A_SUB_CLASS_CHARACTER =
      new SystemMessageId(1500);
  /**
   * ID: 1501<br>
   * Message: $c1 does not meet the participation requirements. Only Noblesse characters can
   * participate in the Olympiad.
   */
  public static final SystemMessageId
      C1_DOES_NOT_MEET_REQUIREMENTS_ONLY_NOBLESS_CAN_PARTICIPATE_IN_THE_OLYMPIAD =
          new SystemMessageId(1501);
  /**
   * ID: 1502<br>
  ...
  public static final SystemMessageId C1_IS_ALREADY_REGISTERED_ON_THE_MATCH_WAITING_LIST =
      new SystemMessageId(1502);
  /**
   * ID: 1503<br>
   * Message: You have been registered for the Grand Olympiad waiting list for a class specific
   * match.
   */
  public static final SystemMessageId
  ...
  public static final SystemMessageId THIS_SKILL_IS_NOT_AVAILABLE_FOR_THE_OLYMPIAD_EVENT =
      new SystemMessageId(1509);
  /**
   * ID: 1510<br>
   * Message: $c1 is making an attempt to resurrect you. If you choose this path, $s2 experience
   * points will be returned to you. Do you want to be resurrected?
   */
  public static final SystemMessageId RESURRECTION_REQUEST_BY_C1_FOR_S2_XP =
      new SystemMessageId(1510);
  /**
   * ID: 1511<br>
  ...
  public static final SystemMessageId CANNOT_EQUIP_ITEM_DUE_TO_BAD_CONDITION =
      new SystemMessageId(1518);
  /**
   * ID: 1519<br>
   * Message: The pet has been killed. If you don't resurrect it within 24 hours, the pet's body
   * will disappear along with all the pet's items.
   */
  public static final SystemMessageId MAKE_SURE_YOU_RESSURECT_YOUR_PET_WITHIN_24_HOURS =
      new SystemMessageId(1519);
  /**
   * ID: 1520<br>
  ...
  /**
   * ID: 1523<br>
   * Message: You should release your pet or servitor so that it does not fall off of the boat and
   * drown!
   */
  ...
  /**
   * ID: 1562<br>
   * Message: A Clan War has been declared against the clan, $s1. If you are killed during the Clan
   * War by members of the opposing clan, you will only lose a quarter of the normal experience from
   * death.
   */
  public static final SystemMessageId CLAN_WAR_DECLARED_AGAINST_S1_IF_KILLED_LOSE_LOW_EXP =
      new SystemMessageId(1562);
  /**
   * ID: 1563<br>
   * Message: The clan, $s1, cannot declare a clan war because their clan is level 2 or lower, and
  ...
  public static final SystemMessageId CANNOT_DECLARE_WAR_TOO_LOW_LEVEL_OR_NOT_ENOUGH_MEMBERS =
      new SystemMessageId(1563);
  /**
   * ID: 1564<br>
   * Message: A clan war can only be declared if the clan is level 3 or above, and the number of
   * clan members is fifteen or greater.
   */
  public static final SystemMessageId CLAN_WAR_DECLARED_IF_CLAN_LVL3_OR_15_MEMBER =
      new SystemMessageId(1564);
  /**
   * ID: 1565<br>
  ...
  /**
   * ID: 1574<br>
   * Message: Command Channels can only be formed by a party leader who is also the leader of a
   * level 5 clan.
   */
  public static final SystemMessageId COMMAND_CHANNEL_ONLY_BY_LEVEL_5_CLAN_LEADER_PARTY_LEADER =
      new SystemMessageId(1574);
  /**
   * ID: 1575<br>
  ...
  /**
   * ID: 1601<br>
   * Message: Tomorrow's items will all be set to the same value as today's items. Do you wish to
   * continue?
   */
  ...
  /**
   * ID: 1604<br>
   * Message: While dressed in formal wear, you can't use items that require all skills and casting
   * operations.
   */
  public static final SystemMessageId CANNOT_USE_ITEMS_SKILLS_WITH_FORMALWEAR =
      new SystemMessageId(1604);
  /**
   * ID: 1605<br>
  ...
  /**
   * ID: 1609<br>
   * Message: War has already been declared against that clan… but I'll make note that you really
   * don't like them.
   */
  ...
  /**
   * ID: 1630<br>
   * Message: The ferry from Rune Harbor will be arriving at Gludin Harbor in approximately 15
   * minutes.
   */
  public static final SystemMessageId FERRY_FROM_RUNE_AT_GLUDIN_15_MINUTES =
      new SystemMessageId(1630);
  /**
   * ID: 1631<br>
   * Message: The ferry from Rune Harbor will be arriving at Gludin Harbor in approximately 10
   * minutes.
   */
  public static final SystemMessageId FERRY_FROM_RUNE_AT_GLUDIN_10_MINUTES =
      new SystemMessageId(1631);
  /**
   * ID: 1632<br>
   * Message: The ferry from Rune Harbor will be arriving at Gludin Harbor in approximately 5
   * minutes.
   */
  public static final SystemMessageId FERRY_FROM_RUNE_AT_GLUDIN_5_MINUTES =
      new SystemMessageId(1632);
  /**
   * ID: 1633<br>
   * Message: The ferry from Rune Harbor will be arriving at Gludin Harbor in approximately 1
   * minute.
   */
  public static final SystemMessageId FERRY_FROM_RUNE_AT_GLUDIN_1_MINUTE =
      new SystemMessageId(1633);
  /**
   * ID: 1634<br>
   * Message: The ferry from Gludin Harbor will be arriving at Rune Harbor in approximately 15
   * minutes.
   */
  public static final SystemMessageId FERRY_FROM_GLUDIN_AT_RUNE_15_MINUTES =
      new SystemMessageId(1634);
  /**
   * ID: 1635<br>
   * Message: The ferry from Gludin Harbor will be arriving at Rune Harbor in approximately 10
   * minutes.
   */
  public static final SystemMessageId FERRY_FROM_GLUDIN_AT_RUNE_10_MINUTES =
      new SystemMessageId(1635);
  /**
   * ID: 1636<br>
   * Message: The ferry from Gludin Harbor will be arriving at Rune Harbor in approximately 5
   * minutes.
   */
  public static final SystemMessageId FERRY_FROM_GLUDIN_AT_RUNE_5_MINUTES =
      new SystemMessageId(1636);
  /**
   * ID: 1637<br>
   * Message: The ferry from Gludin Harbor will be arriving at Rune Harbor in approximately 1
   * minute.
   */
  public static final SystemMessageId FERRY_FROM_GLUDIN_AT_RUNE_1_MINUTE =
      new SystemMessageId(1637);
  /**
   * ID: 1638<br>
  ...
  /**
   * ID: 1641<br>
   * Message: Sharpen your swords, tighten the stitching in your armor, and make haste to a Grand
   * Olympiad Manager! Battles in the Grand Olympiad Games are now taking place!
   */
  public static final SystemMessageId THE_OLYMPIAD_GAME_HAS_STARTED = new SystemMessageId(1641);
  /**
   * ID: 1642<br>
   * Message: Much carnage has been left for the cleanup crew of the Olympiad Stadium. Battles in
   * the Grand Olympiad Games are now over!
   */
  ...
  /**
   * ID: 1662<br>
   * Message: The fish are no longer biting here because you've caught too many! Try fishing in
   * another location.
   */
  public static final SystemMessageId FISH_NO_MORE_BITING_TRY_OTHER_LOCATION =
      new SystemMessageId(1662);
  /**
   * ID: 1663<br>
   * Message: The clan crest was successfully registered. Remember, only a clan that owns a clan
   * hall or castle can display a crest.
   */
  public static final SystemMessageId CLAN_EMBLEM_WAS_SUCCESSFULLY_REGISTERED =
      new SystemMessageId(1663);
  /**
   * ID: 1664<br>
  ...
  /**
   * ID: 1670<br>
   * Message: Due to your Reeling and/or Pumping skill being three or more levels higher than your
   * Fishing skill, a 50 damage penalty will be applied.
   */
  public static final SystemMessageId REELING_PUMPING_3_LEVELS_HIGHER_THAN_FISHING_PENALTY =
      new SystemMessageId(1670);
  /**
   * ID: 1671<br>
  ...
  /**
   * ID: 1673<br>
   * Message: For the current Grand Olympiad you have participated in $s1 match(es). $s2 win(s) and
   * $s3 defeat(s). You currently have $s4 Olympiad Point(s).
   */
  public static final SystemMessageId
  ...
  /**
   * ID: 1677<br>
   * Message: A cease-fire during a Clan War can not be called while members of your clan are
   * engaged in battle.
   */
  public static final SystemMessageId CANT_STOP_CLAN_WAR_WHILE_IN_COMBAT =
      new SystemMessageId(1677);
  /**
   * ID: 1678<br>
  ...
  /**
   * ID: 1687<br>
   * Message: This area cannot be entered while mounted atop of a Wyvern. You will be dismounted
   * from your Wyvern if you do not leave!
   */
  public static final SystemMessageId AREA_CANNOT_BE_ENTERED_WHILE_MOUNTED_WYVERN =
      new SystemMessageId(1687);
  /**
   * ID: 1688<br>
  ...
  public static final SystemMessageId C1_IS_ALREADY_REGISTERED_ON_THE_CLASS_MATCH_WAITING_LIST =
      new SystemMessageId(1689);
  /**
   * ID: 1690<br>
   * Message: $c1 is already registered on the waiting list for the class irrelevant individual
   * match.
   */
  public static final SystemMessageId
      C1_IS_ALREADY_REGISTERED_ON_THE_NON_CLASS_LIMITED_MATCH_WAITING_LIST =
          new SystemMessageId(1690);
  /**
   * ID: 1691<br>
   * Message: $c1 does not meet the participation requirements. You cannot participate in the
   * Olympiad because your inventory slot exceeds 80%.
   */
  public static final SystemMessageId
      C1_CANNOT_PARTICIPATE_IN_OLYMPIAD_INVENTORY_SLOT_EXCEEDS_80_PERCENT =
          new SystemMessageId(1691);
  /**
   * ID: 1692<br>
   * Message: $c1 does not meet the participation requirements. You cannot participate in the
   * Olympiad because you have changed to your sub-class.
   */
  public static final SystemMessageId C1_CANNOT_PARTICIPATE_IN_OLYMPIAD_WHILE_CHANGED_TO_SUB_CLASS =
      new SystemMessageId(1692);
  /**
   * ID: 1693<br>
  ...
  public static final SystemMessageId
      WHILE_YOU_ARE_ON_THE_WAITING_LIST_YOU_ARE_NOT_ALLOWED_TO_WATCH_THE_GAME =
          new SystemMessageId(1693);
  /**
   * ID: 1694<br>
   * Message: Only a clan leader that is a Noblesse can view the Siege War Status window during a
   * siege war.
   */
  public static final SystemMessageId ONLY_NOBLESSE_LEADER_CAN_VIEW_SIEGE_STATUS_WINDOW =
      new SystemMessageId(1694);
  /**
   * ID: 1695<br>
  ...
  /**
   * ID: 1697<br>
   * Message: Your accumulated play time has reached Fatigue level, so you will receive experience
   * or item drops at only 50 percent of the normal rate. For the sake of you physical and emotional
   * health, we encourage you to log out as soon as possible and take a break before returning.
   */
  public static final SystemMessageId ACCUMULATED_PLAY_TIME_WARNING1 = new SystemMessageId(1697);
  /**
   * ID: 1698<br>
   * Message: Your accumulated play time has reached Ill-health level, so you will no longer gain
   * experience or item drops. For the sake of your physical and emotional health, please log out as
   * soon as possible and take a break. Once you have been logged out for at least 5 hours, the
   * experience and item drop rate penalties will be removed.
   */
  ...
  /**
   * ID: 1704<br>
   * Message: Please close the setup window for your private manufacturing store or private store,
   * and try again.
   */
   ...
   * dies in this zone, their resurrection ability may be restricted.
   */
  ...
  /**
   * ID: 1719<br>
   * Message: Seven Signs Zone \\n- Although a character's level may increase while in this area, HP
  ...
  /**
   * ID: 1734<br>
   * Message: To join a Clan Academy, characters must be Level 40 or below, not belong another clan
   * and not yet completed their 2nd class transfer.
   */
  ...
  /**
   * ID: 1743<br>
   * Message: To open a Clan Academy, the leader of a Level 5 clan or above must pay XX Proofs of
   * Blood or a certain amount of adena.
   */
  public static final SystemMessageId OPEN_ACADEMY_CONDITIONS = new SystemMessageId(1743);
  /**
   * ID: 1744<br>
   * Message: There was no response to your invitation to join the Clan Academy, so the invitation
   * has been rescinded.
   */
  ...
  /**
   * ID: 1747<br>
   * Message: $s1 has sent you an invitation to join the Clan Academy belonging to the $s2 clan. Do
   * you accept?
   */
  public static final SystemMessageId JOIN_ACADEMY_REQUEST_BY_S1_FOR_CLAN_S2 =
      new SystemMessageId(1747);
  /**
   * ID: 1748<br>
   * Message: Clan Academy member $s1 has successfully completed the 2nd class transfer and obtained
   * $s2 Clan Reputation points.
   */
  public static final SystemMessageId CLAN_MEMBER_GRADUATED_FROM_ACADEMY =
      new SystemMessageId(1748);
  /**
   * ID: 1749<br>
   * Message: Congratulations! You will now graduate from the Clan Academy and leave your current
   * clan. As a graduate of the academy, you can immediately join a clan as a regular member without
   * being subject to any penalties.
   */
  public static final SystemMessageId ACADEMY_MEMBERSHIP_TERMINATED = new SystemMessageId(1749);
  /**
   * ID: 1750<br>
   * Message: $c1 does not meet the participation requirements. The owner of $s2 cannot participate
   * in the Olympiad.
   */
  public static final SystemMessageId C1_CANNOT_JOIN_OLYMPIAD_POSSESSING_S2 =
      new SystemMessageId(1750);
  /**
   * ID: 1751<br>
  ...
  /**
   * ID: 1752<br>
   * Message: Since the clan has received a graduate of the Clan Academy, it has earned $s1 points
   * toward its reputation score.
   */
  public static final SystemMessageId MEMBER_GRADUATED_EARNED_S1_REPU = new SystemMessageId(1752);
  /**
   * ID: 1753<br>
   * Message: The clan leader has decreed that that particular privilege cannot be granted to a Clan
   * Academy member.
   */
  public static final SystemMessageId CANT_TRANSFER_PRIVILEGE_TO_ACADEMY_MEMBER =
      new SystemMessageId(1753);
  /**
   * ID: 1754<br>
  ...
  public static final SystemMessageId JOIN_REQUEST_BY_C1_TO_CLAN_S2_ACADEMY =
      new SystemMessageId(1768);
  /**
   * ID: 1769<br>
   * Message: $c1 has sent you an invitation to join the $s3 Order of Knights under the $s2 clan.
   * Would you like to join?
   */
  public static final SystemMessageId JOIN_REQUEST_BY_C1_TO_ORDER_OF_KNIGHTS_S3_UNDER_CLAN_S2 =
      new SystemMessageId(1769);
  /**
   * ID: 1770<br>
   * Message: The clan's reputation score has dropped below 0. The clan may face certain penalties
   * as a result.
   */
  ...
  public static final SystemMessageId CLAN_CAN_ACCUMULATE_CLAN_REPUTATION_POINTS =
      new SystemMessageId(1771);
  /**
   * ID: 1772<br>
   * Message: Since your clan was defeated in a siege, $s1 points have been deducted from your
   * clan's reputation score and given to the opposing clan.
   */
  public static final SystemMessageId CLAN_WAS_DEFEATED_IN_SIEGE_AND_LOST_S1_REPUTATION_POINTS =
      new SystemMessageId(1772);
  /**
   * ID: 1773<br>
   * Message: Since your clan emerged victorious from the siege, $s1 points have been added to your
   * clan's reputation score.
   */
  public static final SystemMessageId CLAN_VICTORIOUS_IN_SIEGE_AND_GAINED_S1_REPUTATION_POINTS =
      new SystemMessageId(1773);
  /**
   * ID: 1774<br>
   * Message: Your clan's newly acquired contested clan hall has added $s1 points to your clan's
   * reputation score.
   */
  public static final SystemMessageId CLAN_ACQUIRED_CONTESTED_CLAN_HALL_AND_S1_REPUTATION_POINTS =
      new SystemMessageId(1774);
  /**
   * ID: 1775<br>
   * Message: Clan member $c1 was an active member of the highest-ranked party in the Festival of
   * Darkness. $s2 points have been added to your clan's reputation score.
   */
  public static final SystemMessageId
  ...
  /**
   * ID: 1776<br>
   * Message: Clan member $c1 was named a hero. $2s points have been added to your clan's reputation
   * score.
   */
  public static final SystemMessageId CLAN_MEMBER_C1_BECAME_HERO_AND_GAINED_S2_REPUTATION_POINTS =
      new SystemMessageId(1776);
  /**
   * ID: 1777<br>
  ...
  public static final SystemMessageId CLAN_QUEST_COMPLETED_AND_S1_POINTS_GAINED =
      new SystemMessageId(1777);
  /**
   * ID: 1778<br>
   * Message: An opposing clan has captured your clan's contested clan hall. $s1 points have been
  ...
  /**
   * ID: 1779<br>
   * Message: After losing the contested clan hall, 300 points have been deducted from your clan's
   * reputation score.
   */
  public static final SystemMessageId CLAN_LOST_CONTESTED_CLAN_HALL_AND_300_POINTS =
      new SystemMessageId(1779);
  /**
   * ID: 1780<br>
   * Message: Your clan has captured your opponent's contested clan hall. $s1 points have been
   * deducted from your opponent's clan reputation score.
   */
  public static final SystemMessageId
      CLAN_CAPTURED_CONTESTED_CLAN_HALL_AND_S1_POINTS_DEDUCTED_FROM_OPPONENT =
          new SystemMessageId(1780);
  /**
   * ID: 1781<br>
  ...
  public static final SystemMessageId CLAN_ADDED_S1S_POINTS_TO_REPUTATION_SCORE =
      new SystemMessageId(1781);
  /**
   * ID: 1782<br>
   * Message: Your clan member, $c1, was killed. $s2 points have been deducted from your clan's
   * reputation score and added to your opponent's clan reputation score.
   */
  public static final SystemMessageId
      CLAN_MEMBER_C1_WAS_KILLED_AND_S2_POINTS_DEDUCTED_FROM_REPUTATION = new SystemMessageId(1782);
  /**
   * ID: 1783<br>
   * Message: For killing an opposing clan member, $s1 points have been deducted from your
   * opponents' clan reputation score.
   */
  public static final SystemMessageId
      FOR_KILLING_OPPOSING_MEMBER_S1_POINTS_WERE_DEDUCTED_FROM_OPPONENTS =
          new SystemMessageId(1783);
  /**
   * ID: 1784<br>
   * Message: Your clan has failed to defend the castle. $s1 points have been deducted from your
   * clan's reputation score and added to your opponents'.
   */
  public static final SystemMessageId
      YOUR_CLAN_FAILED_TO_DEFEND_CASTLE_AND_S1_POINTS_LOST_AND_ADDED_TO_OPPONENT =
          new SystemMessageId(1784);
  /**
   * ID: 1785<br>
   * Message: The clan you belong to has been initialized. $s1 points have been deducted from your
   * clan reputation score.
   */
  public static final SystemMessageId YOUR_CLAN_HAS_BEEN_INITIALIZED_AND_S1_POINTS_LOST =
      new SystemMessageId(1785);
  /**
   * ID: 1786<br>
   * Message: Your clan has failed to defend the castle. $s1 points have been deducted from your
   * clan's reputation score.
  ...
  /**
   * ID: 1789<br>
   * Message: Since the Clan Reputation Score has dropped to 0 or lower, your clan skill(s) will be
   * de-activated.
   */
  public static final SystemMessageId REPUTATION_POINTS_0_OR_LOWER_CLAN_SKILLS_DEACTIVATED =
      new SystemMessageId(1789);
  /**
   * ID: 1790<br>
  ...
  public static final SystemMessageId THE_ROYAL_GUARD_OF_S1_HAVE_BEEN_CREATED =
      new SystemMessageId(1795);
  /**
   * ID: 1796<br>
   * Message: Your account has been temporarily suspended because of involvement in account theft or
   * other abnormal game play which has harmed or inconvenienced other players. If you feel that you
   * were not involved with any of these violations, please visit the Support Center on the PlayNC
   * website (http://us.ncsoft.com/support/).
   */
  ...
  /**
   * ID: 1804<br>
   * Message: Your account has been suspended for 7 days because an illicit cash/account transaction
   * has been detected. For more information, please visit the Support Center on the PlayNC website
   * (http://us.ncsoft.com/support/).
   */
  public static final SystemMessageId ILLEGAL_USE18 = new SystemMessageId(1804);
  /**
   * ID: 1805<br>
   * Message: Your account has been suspended for 30 days because an illicit cash/account
   * transaction has been detected for the second time. For more information, please visit the
   * Support Center on the PlayNC website (http://us.ncsoft.com/support/).
   */
  public static final SystemMessageId ILLEGAL_USE19 = new SystemMessageId(1805);
  /**
   * ID: 1806<br>
   * Message: Your account has been permanently suspended because an illicit cash/account
   * transaction has been detected for the third time. For more information, please visit the
   * Support Center on the PlayNC website (http://us.ncsoft.com/support/).
   */
  public static final SystemMessageId ILLEGAL_USE20 = new SystemMessageId(1806);
  /**
   * ID: 1807<br>
   * Message: Your account has been suspended for 30 days because of your involvement in an illicit
   * cash transaction. For more information, please visit the Support Center on the PlayNC website
   * (http://us.ncsoft.com/support/).
   */
  public static final SystemMessageId ILLEGAL_USE21 = new SystemMessageId(1807);
  /**
   * ID: 1808<br>
   * Message: Your account has been permanently suspended because of your involvement in an illicit
   * cash/account transaction. For more information, please visit the Support Center on the PlayNC
   * website (http://us.ncsoft.com/support/).
   */
  public static final SystemMessageId ILLEGAL_USE22 = new SystemMessageId(1808);
  /**
   * ID: 1809<br>
   * Message: Your account must be verified. For information on verification procedures, please
   * visit the PlayNC website (http://us.ncsoft.com/support/).
   */
  ...
  public static final SystemMessageId CLANHALL_WAR_REGISTRATION_PERIOD_ENDED =
      new SystemMessageId(1823);
  /**
   * ID: 1824<br>
   * Message: You have been registered for a clan hall war. Please move to the left side of the clan
   * hall's arena and get ready.
   */
  ...
  /**
   * ID: 1826<br>
   * Message: In $s1 minute(s), the game will begin. All players must hurry and move to the left
   * side of the clan hall's arena.
   */
  ...
  /**
   * ID: 1830<br>
   * Message: $c1 is not allowed to use the party room invite command. Please update the waiting
   * list.
   */
  public static final SystemMessageId C1_NOT_ALLOWED_INVITE_TO_PARTY_ROOM =
      new SystemMessageId(1830);
  /**
   * ID: 1831<br>
  ...
  /**
   * ID: 1836<br>
   * Message: You cannot join a Clan Academy because you have successfully completed your 2nd class
   * transfer.
   */
  public static final SystemMessageId CANNOT_JOIN_ACADEMY_AFTER_2ND_OCCUPATION =
      new SystemMessageId(1836);
  /**
   * ID: 1837<br>
   * Message: $c1 has sent you an invitation to join the $s3 Royal Guard under the $s2 clan. Would
   * you like to join?
   */
  public static final SystemMessageId C1_SENT_INVITATION_TO_ROYAL_GUARD_S3_OF_CLAN_S2 =
      new SystemMessageId(1837);
  /**
   * ID: 1838<br>
  ...
  public static final SystemMessageId CAPTAIN_OF_ROYAL_GUARD_CANNOT_BE_APPOINTED =
      new SystemMessageId(1851);
  /**
   * ID: 1852<br>
   * Message: The attempt to acquire the skill has failed because of an insufficient Clan Reputation
   * Score.
   */
  public static final SystemMessageId ACQUIRE_SKILL_FAILED_BAD_CLAN_REP_SCORE =
      new SystemMessageId(1852);
  /**
   * ID: 1853<br>
  ...
  /**
   * ID: 1887<br>
   * Message: Invalid serial number. Your attempt to enter the number has failed $s1 time(s). You
   * will be allowed to make $s2 more attempt(s).
   */
  public static final SystemMessageId SERIAL_NUMBER_ENTERING_FAILED = new SystemMessageId(1887);
  /**
   * ID: 1888<br>
   * Message: Invalid serial number. Your attempt to enter the number has failed 5 times. Please try
   * again in 4 hours.
   */
  public static final SystemMessageId SERIAL_NUMBER_ENTERING_FAILED_5_TIMES =
      new SystemMessageId(1888);
  /**
   * ID: 1889<br>
   ...
   */
  public static final SystemMessageId
      C1_CURRENTLY_TRADING_OR_OPERATING_PRIVATE_STORE_AND_CANNOT_BE_SUMMONED =
          new SystemMessageId(1898);
  /**
   * ID: 1899<br>
  ...
  public static final SystemMessageId OLYMPIAD_REGISTRATION_PERIOD_ENDED =
      new SystemMessageId(1919);
  /**
   * ID: 1920<br>
   * Message: Your account is currently inactive because you have not logged into the game for some
   * time. You may reactivate your account by visiting the PlayNC website
   * (http://us.ncsoft.com/support/).
   */
  ...
  public static final SystemMessageId C1_HAS_DECLINED_YOUR_CHALLENGE_TO_A_DUEL =
      new SystemMessageId(1931);
  /**
   * ID: 1932<br>
   * Message: $c1 has declined your challenge to a duel.
   */
  public static final SystemMessageId C1_HAS_DECLINED_YOUR_CHALLENGE_TO_A_DUEL2 =
      new SystemMessageId(1932);
  /**
   * ID: 1933<br>
   * Message: You have accepted $c1's challenge to a party duel. The duel will begin in a few
   * moments.
   */
  public static final SystemMessageId
      YOU_HAVE_ACCEPTED_C1_CHALLENGE_TO_A_PARTY_DUEL_THE_DUEL_WILL_BEGIN_IN_A_FEW_MOMENTS =
          new SystemMessageId(1933);
  /**
   * ID: 1934<br>
   * Message: $s1 has accepted your challenge to duel against their party. The duel will begin in a
   * few moments.
   */
  public static final SystemMessageId
  ...
  public static final SystemMessageId THE_OPPOSING_PARTY_HAS_DECLINED_YOUR_CHALLENGE_TO_A_DUEL =
      new SystemMessageId(1936);
  /**
   * ID: 1937<br>
   * Message: Since the person you challenged is not currently in a party, they cannot duel against
   * your party.
   */
  public static final SystemMessageId
  ...
  public static final SystemMessageId YOUR_SEED_OR_REMAINING_PURCHASE_AMOUNT_IS_INADEQUATE =
      new SystemMessageId(2013);
  /**
   * ID: 2014<br>
   * Message: You cannot proceed because the manor cannot accept any more crops. All crops have been
   * returned and no adena withdrawn.
   */
  ...
  public static final SystemMessageId C1_CANNOT_DUEL_BECAUSE_C1_HP_OR_MP_IS_BELOW_50_PERCENT =
      new SystemMessageId(2019);
  /**
   * ID: 2020<br>
   * Message: $c1 cannot make a challenge to a duel because $c1 is currently in a duel-prohibited
   * area (Peaceful Zone / Seven Signs Zone / Near Water / Restart Prohibited Area).
   */
  public static final SystemMessageId
  ...
  /**
   * ID: 2033<br>
   * Message: A sub-class cannot be created or changed because you have exceeded your inventory
   * limit.
   */
  public static final SystemMessageId NOT_SUBCLASS_WHILE_INVENTORY_FULL = new SystemMessageId(2033);
  /**
   * ID: 2034<br>
   * Message: There are $s1 hours(s) and $s2 minute(s) remaining until the item can be purchased
   * again.
   */
  public static final SystemMessageId ITEM_PURCHASABLE_IN_S1_HOURS_S2_MINUTES =
      new SystemMessageId(2034);
  /**
   * ID: 2035<br>
  ...
  /**
   * ID: 2037<br>
   * Message: Unable to create character. You are unable to create a new character on the selected
   * server. A restriction is in place which restricts users from creating characters on different
   * servers where no previous character exists. Please choose another server.
   */
  public static final SystemMessageId CANT_CREATE_CHARACTER_DURING_RESTRICTION =
      new SystemMessageId(2037);
  /**
   * ID: 2038<br>
   * Message: Some Lineage II features have been limited for free trials. Trial accounts aren’t
   * allowed to drop items and/or Adena. To unlock all of the features of Lineage II, purchase the
   * full version today.
   */
   ...
   * ID: 2039<br>
   * Message: Some Lineage II features have been limited for free trials. Trial accounts aren’t
   * allowed to trade items and/or Adena. To unlock all of the features of Lineage II, purchase the
   * full version today.
   */
   ...
   * ID: 2041<br>
   * Message: Some Lineage II features have been limited for free trials. Trial accounts aren’t
   * allowed to setup private stores. To unlock all of the features of Lineage II, purchase the full
   * version today.
   */
  public static final SystemMessageId CANT_OPEN_PRIVATE_STORE = new SystemMessageId(2041);
  /**
   * ID: 2042<br>
   * Message: This account has been suspended for non-payment based on the cell phone payment
   * agreement.\\n Please submit proof of payment by fax (02-2186-3499) and contact customer service
   * at 1600-0020.
   */
  public static final SystemMessageId ILLEGAL_USE23 = new SystemMessageId(2042);
  /**
   * ID: 2043<br>
   * Message: You have exceeded your inventory volume limit and may not take this quest item. Please
   * make room in your inventory and try again.
   */
  public static final SystemMessageId
      YOU_HAVE_EXCEEDED_YOUR_INVENTORY_VOLUME_LIMIT_AND_CANNOT_TAKE_THIS_QUESTITEM =
          new SystemMessageId(2043);
  /**
   * ID: 2044<br>
   * Message: Some Lineage II features have been limited for free trials. Trial accounts aren’t
   * allowed to set up private manufacturing stores. To unlock all of the features of Lineage II,
   ...
   * ID: 2045<br>
   * Message: Some Lineage II features have been limited for free trials. Trial accounts aren’t
   * allowed to use private manufacturing stores. To unlock all of the features of Lineage II,
   * purchase the full version today.
   */
   ...
   * ID: 2046<br>
   * Message: Some Lineage II features have been limited for free trials. Trial accounts aren’t
   * allowed buy items from private stores. To unlock all of the features of Lineage II, purchase
   ...
   * ID: 2047<br>
   * Message: Some Lineage II features have been limited for free trials. Trial accounts aren’t
   * allowed to access clan warehouses. To unlock all of the features of Lineage II, purchase the
   * full version today.
   */
  ...
  /**
   * ID: 2052<br>
   * Message: A guardian's consent is required before this account can be used to play Lineage
  ...
  public static final SystemMessageId ACCOUNT_DECLINED_AGREEMENT_OR_PENDING =
      new SystemMessageId(2053);
  /**
   * ID: 2054<br>
   * Message: This account has been suspended. \\nFor more information, please call the Customer's
   * Center (Tel. 1600-0020).
   */
   ...
   * visit the PlayNC website Customer's Center (http://us.ncsoft.com).
   */
  public static final SystemMessageId ACCOUNT_SUSPENDED_FROM_ALL_SERVICES =
      new SystemMessageId(2055);
  /**
   * ID: 2056<br>
   * Message: Your account has been converted to an integrated account, and is unable to be
  ...
  public static final SystemMessageId YOU_ALREADY_POLYMORPHED_AND_CANNOT_POLYMORPH_AGAIN =
      new SystemMessageId(2058);
  /**
   * ID: 2059<br>
   * Message: The nearby area is too narrow for you to polymorph. Please move to another area and
   * try to polymorph again.
   */
  ...
  public static final SystemMessageId YOU_DONT_HAVE_ALL_ITENS_NEEDED_TO_UNTRAIN_SKILL_ENCHANT =
      new SystemMessageId(2068);
  /**
   * ID: 2069<br>
   * Message: Untrain of enchant skill was successful. Current level of enchant skill $s1 has been
   * decreased by 1.
   */
  public static final SystemMessageId UNTRAIN_SUCCESSFUL_SKILL_S1_ENCHANT_LEVEL_DECREASED_BY_ONE =
      new SystemMessageId(2069);
  /**
   * ID: 2070<br>
  ...
  public static final SystemMessageId YOU_DONT_HAVE_ALL_ITENS_NEEDED_TO_CHANGE_SKILL_ENCHANT_ROUTE =
      new SystemMessageId(2071);
  /**
   * ID: 2072<br>
   * Message: Enchant skill route change was successful. Lv of enchant skill $s1 has been decreased
   * by $s2.
   */
  public static final SystemMessageId SKILL_ENCHANT_CHANGE_SUCCESSFUL_S1_LEVEL_WAS_DECREASED_BY_S2 =
      new SystemMessageId(2072);
  /**
   * ID: 2073<br>
   ...
   */
  public static final SystemMessageId
      SHOUT_AND_TRADE_CHAT_CANNOT_BE_USED_WHILE_POSSESSING_CURSED_WEAPON =
          new SystemMessageId(2085);
  /**
   * ID: 2086<br>
   ...
   * be available after changing your password and quiz from the PlayNC website
   * (http://us.ncsoft.com).
   */
  ...
  public static final SystemMessageId ANOTHER_USER_PURCHASING_TRY_AGAIN_LATER =
      new SystemMessageId(2094);
  /**
   * ID: 2095<br>
   * Message: Some Lineage II features have been limited for free trials. Trial accounts have
   * limited chatting capabilities. To unlock all of the features of Lineage II, purchase the full
   * version today.
   */
  ...
  public static final SystemMessageId MAXIMUM_INSTANCE_ZONE_NUMBER_EXCEEDED_CANT_ENTER =
      new SystemMessageId(2104);
  /**
   * ID: 2105<br>
   * Message: You have entered another instance zone, therefore you cannot enter corresponding
   * dungeon.
   */
  public static final SystemMessageId
      YOU_HAVE_ENTERED_ANOTHER_INSTANT_ZONE_THEREFORE_YOU_CANNOT_ENTER_CORRESPONDING_DUNGEON =
          new SystemMessageId(2105);
  /**
   * ID: 2106<br>
   * Message: This dungeon will expire in $s1 minute(s). You will be forced out of the dungeon when
   * the time expires.
   */
  public static final SystemMessageId DUNGEON_EXPIRES_IN_S1_MINUTES = new SystemMessageId(2106);
  /**
   * ID: 2107<br>
   * Message: This instance zone will be terminated in $s1 minute(s). You will be forced out of the
   * dungeon when the time expires.
   */
  public static final SystemMessageId INSTANCE_ZONE_TERMINATES_IN_S1_MINUTES =
      new SystemMessageId(2107);
  /**
   * ID: 2108<br>
   * Message: Your account has been suspended for 10 days for use of illegal software and may be
   * permanently suspended. For more information, please visit the Support Center on the PlayNC
   * website (http://us.ncsoft.com/support/).
   */
  public static final SystemMessageId ILLEGAL_USE24 = new SystemMessageId(2108);
  /**
   * ID: 2109<br>
   * Message: During the server merge, your character name, $s1, conflicted with another. Your name
   * may still be available. Please enter your desired name.
   */
  public static final SystemMessageId CHARACTER_NAME_OVERLAPPING_RENAME_CHARACTER =
      new SystemMessageId(2109);
  /**
   * ID: 2110<br>
  ...
  /**
   * ID: 2113<br>
   * Message: CTRL, ALT, SHIFT keys may be used as sub-key in expanded sub-key mode, and only ALT
   * may be used as a sub-key in standard sub-key mode.
   */
  public static final SystemMessageId SUBKEY_EXPLANATION2 = new SystemMessageId(2113);
  /**
   * ID: 2114<br>
   * Message: Forced attack and stand-in-place attacks assigned previously to Ctrl and Shift will be
   * changed to Alt + Q and Alt + E when set as expanded sub-key mode, and CTRL and SHIFT will be
   * available to assign to another shortcut. Will you continue?
   */
  public static final SystemMessageId SUBKEY_EXPLANATION3 = new SystemMessageId(2114);
  /**
   * ID: 2115<br>
   * Message: Your account has been suspended for abusing a bug related to the NCcoin. For more
   * information, please visit the Support Center on the PlayNC website
   * (http://us.ncsoft.com/support/).
   */
  public static final SystemMessageId ILLEGAL_USE25 = new SystemMessageId(2115);
  /**
   * ID: 2116<br>
   * Message: Your account has been suspended for abusing a free NCcoin. For more information,
  ...
  /**
   * ID: 2117<br>
   * Message: Your account has been suspended for using another person's identification. If you were
   * not involved with any of these violations, please verify your identity. For more information,
   * please visit the PlayNC website Customer's Center (http://us.ncsoft.com).
   */
  public static final SystemMessageId ILLEGAL_USE27 = new SystemMessageId(2117);
  /**
   * ID: 2118<br>
   * Message: Your account has been suspended for misappropriating payment under another player's
   * account. For more information, please visit the Customer Service Center of the PlayNC website
   * (http://us.ncsoft.com).
   */
  public static final SystemMessageId ILLEGAL_USE28 = new SystemMessageId(2118);
  /**
   * ID: 2119<br>
   * Message: Your account has been suspended from all game services after being detected with
   * dealing an account.\\nFor more information, please visit the PlayNC website Customer's Center
   * (http://us.ncsoft.com).
   */
  public static final SystemMessageId ILLEGAL_USE29 = new SystemMessageId(2119);
  /**
   * ID: 2120<br>
   * Message: Your account has been suspended for 10 days for using illegal software. Your account
   * may be suspended permanently if you have been previously caught for the same violation. For
   * more information, please visit the PlayNC website Customer's Center (http://us.ncsoft.com).
   */
  public static final SystemMessageId ILLEGAL_USE30 = new SystemMessageId(2120);
  /**
   * ID: 2121<br>
   * Message: Your account has been suspended from all game services for use of illegal software.
   * For more information, please visit the Support Center on the PlayNC website
   * (http://us.ncsoft.com/support/).
   */
  ...
  /**
   * ID: 2123<br>
   * Message: Your account has been suspended at your own request. For more information, please
   * visit the Support Center on the PlayNC website (http://us.ncsoft.com/support/).
   */
  public static final SystemMessageId ILLEGAL_USE33 = new SystemMessageId(2123);
  /**
   * ID: 2124<br>
   * Message: During the server merge, your clan name, $s1, conflicted with another. Your clan name
   * may still be available. Please enter your desired name.
   */
  ...
  /**
   * ID: 2126<br>
   * Message: Your account has been suspended for regularly posting illegal messages. For more
   * information, please visit the Support Center on the PlayNC website
   * (http://us.ncsoft.com/support/).
   */
  ...
  /**
   * ID: 2127<br>
   * Message: Your account has been suspended after being detected with an illegal message. For more
   * information, please visit the Support Center on the PlayNC website
   * (http://us.ncsoft.com/support/).
   */
  ...
  /**
   * ID: 2128<br>
   * Message: Your account has been suspended from all game services for using the game for
   * commercial purposes. For more information, please visit the Support Center on the PlayNC
   * website (http://us.ncsoft.com/support/).
   */
  public static final SystemMessageId ILLEGAL_USE36 = new SystemMessageId(2128);
  /**
   * ID: 2129<br>
   * Message: The augmented item cannot be converted. Please convert after the augmentation has been
   * removed.
   */
  ...
  /**
   * ID: 2131<br>
   * Message: You have bid the highest price and have won the item. The item can be found in your
   * personal warehouse.
   */
  public static final SystemMessageId WON_BID_ITEM_CAN_BE_FOUND_IN_WAREHOUSE =
      new SystemMessageId(2131);
  /**
   * ID: 2132<br>
  ...
  public static final SystemMessageId OPPONENT_HAS_RESISTANCE_MAGIC_DAMAGE_DECREASED =
      new SystemMessageId(2151);
  /**
   * ID: 2152<br>
   * Message: The assigned shortcut will be deleted and the initial shortcut setting restored. Will
   * you continue?
   */
  public static final SystemMessageId CONFIRM_SHORCUT_DELETE = new SystemMessageId(2152);
  /**
   * ID: 2153<br>
   * Message: You are currently logged into 10 of your accounts and can no longer access your other
   * accounts.
   */
  ...
  public static final SystemMessageId THE_TARGET_IS_NOT_A_FLAGPOLE_SO_A_FLAG_CANNOT_BE_DISPLAYED =
      new SystemMessageId(2154);
  /**
   * ID: 2155<br>
   * Message: A flag is already being displayed, another flag cannot be displayed.
   */
  public static final SystemMessageId
      A_FLAG_IS_ALREADY_BEING_DISPLAYED_ANOTHER_FLAG_CANNOT_BE_DISPLAYED =
          new SystemMessageId(2155);
  /**
   * ID: 2156<br>
  ...
  /**
   * ID: 2191<br>
   * Message: To apply selected options, the game needs to be reloaded. If you don't apply now, it
   * will be applied when you start the game next time. Will you apply now?
   */
  ...
  public static final SystemMessageId CANT_ENTER_INSTANCE_ZONE_NPC_SERVER_OFFLINE =
      new SystemMessageId(2199);
  /**
   * ID: 2200<br>
   * Message: This instance zone will be terminated as the NPC server is down. You will be forcibly
   * removed from the dungeon shortly.
   */
  public static final SystemMessageId INSTANCE_ZONE_TERMINATED_NPC_SERVER_OFFLINE =
      new SystemMessageId(2200);
  /**
   * ID: 2201<br>
  ...
  /**
   * ID: 2205<br>
   * Message: You have entered an area where the mini map cannot be used. Your mini map has been
   * closed.
   */
  ...
  /**
   * ID: 2227<br>
   * Message: It is not possible to register for the castle siege side or castle siege of a higher
   * castle in the contract.
   */
  public static final SystemMessageId NOT_POSSIBLE_TO_REGISTER_TO_CASTLE_SIEGE =
      new SystemMessageId(2227);
  /**
   * ID: 2228<br>
  ...
  public static final SystemMessageId AVAILABLE_AFTER_S1_S2_HOURS_S3_MINUTES =
      new SystemMessageId(2230);
  /**
   * ID: 2231<br>
   * Message: The supply items have not been provided because the castle you are in contract with
   * doesn't have enough clan reputation.
   */
  public static final SystemMessageId REPUTATION_SCORE_FOR_CONTRACT_NOT_ENOUGH =
      new SystemMessageId(2231);
  /**
   * ID: 2232<br>
  ...
  /**
   * ID: 2240<br>
   * Message: You cannot register for a Clan Hall War when the Clan Lord is in the process of
   * re-delegating clan authority to another leader.
   */
  public static final SystemMessageId
      CANT_REGISTER_TO_TEAM_BATTLE_CLAN_HALL_WAR_WHILE_LORD_ON_TRANSACTION_WAITING_LIST =
          new SystemMessageId(2240);
  /**
   * ID: 2241<br>
   * Message: You cannot apply for a Clan Lord delegation request if your clan has registered for a
   * Clan Hall War.
   */
  public static final SystemMessageId
      CANT_APPLY_ON_LORD_TRANSACTION_WHILE_REGISTERED_TO_TEAM_BATTLE_CLAN_HALL_WAR =
          new SystemMessageId(2241);
  /**
   * ID: 2242<br>
  ...
  /**
   * ID: 2243<br>
   * Message: During the Bandit Stronghold or Wild Beast Reserve clan hall war, the previous clan
   * lord rather than the new clan lord participates in battle.
   */
  public static final SystemMessageId
  ...
  /**
   * ID: 2273<br>
   * Message: This skill cannot be learned while in the sub-class state. Please try again after
   * changing to the main class.
   */
  ...
  /**
   * ID: 2302<br>
   * Message: Your Dimensional Item has arrived! Visit the Dimensional Merchant in any village to
   * obtain it.
   */
  ...
  public static final SystemMessageId S2_MINUTES_S3_SECONDS_REMAINING_FOR_REUSE_S1 =
      new SystemMessageId(2304);
  /**
   * ID: 2305<br>
   * Message: There are $s2 hour(s), $s3 minute(s), and $s4 second(s) remaining in $s1's re-use
   * time.
   */
  public static final SystemMessageId S2_HOURS_S3_MINUTES_S4_SECONDS_REMAINING_FOR_REUSE_S1 =
      new SystemMessageId(2305);
  /**
   * ID: 2306<br>
  ...
  /**
   * ID: 2333<br>
   * Message: You cannot receive the Dimensional Item because you have exceed your inventory
   * weight/quantity limit.
   */
  public static final SystemMessageId YOU_CANNOT_RECEIVE_THE_VITAMIN_ITEM =
      new SystemMessageId(2333);
  /**
   * ID: 2335<br>
  ...
  /**
   * ID: 2349<br>
   * Message: You cannot use My Teleports while participating a large-scale battle such as a castle
   * siege, fortress siege, or hideout siege.
   */
  public static final SystemMessageId YOU_CANNOT_USE_MY_TELEPORTS_WHILE_PARTICIPATING =
      new SystemMessageId(2349);
  /**
   * ID: 2350<br>
  ...
  public static final SystemMessageId YOU_CANNOT_USE_MY_TELEPORTS_WHILE_FLYING =
      new SystemMessageId(2351);
  /**
   * ID: 2352<br>
   * Message: You cannot use My Teleports while participating in an Olympiad match.
   */
  public static final SystemMessageId
      YOU_CANNOT_USE_MY_TELEPORTS_WHILE_PARTICIPATING_IN_AN_OLYMPIAD_MATCH =
          new SystemMessageId(2352);
  /**
   * ID: 2353<br>
  ...
  /**
   * ID: 2375<br>
   * Message: Your minion cannot be returned because there is not much time remaining until it
   * leaves.
   */
  ...
  public static final SystemMessageId YOU_HAVE_USED_THE_FEATHER_OF_BLESSING_TO_RESURRECT =
      new SystemMessageId(2391);
  /**
   * ID: 2392<br>
   * Message: The Dimensional Item cannot be located because of a temporary connection error.
   */
  public static final SystemMessageId
      THE_DIMENSIONAL_ITEM_CANNOT_BE_LOCATED_BECAUSE_OF_A_TEMPORARY_CONNECTION_ERROR =
          new SystemMessageId(2392);
  /**
   * ID: 2393<br>
   ...
   */
  public static final SystemMessageId
      THAT_SKILL_CANNOT_BE_USED_BECAUSE_YOUR_PET_SERVITOR_LACKS_SUFFICIENT_MP =
          new SystemMessageId(2394);
  /**
   * ID: 2395<br>
   * Message: That skill cannot be used because your pet/servitor lacks sufficient HP.
   */
  public static final SystemMessageId
      THAT_SKILL_CANNOT_BE_USED_BECAUSE_YOUR_PET_SERVITOR_LACKS_SUFFICIENT_HP =
          new SystemMessageId(2395);
  /**
   * ID: 2396<br>
  ...
  /**
   * ID: 2440<br>
   * Message: $c1 is already registered on the waiting list for the 3 vs. 3 class irrelevant team
   * match.
   */
  public static final SystemMessageId C1_IS_ALREADY_REGISTERED_NON_CLASS_LIMITED_EVENT_TEAMS =
      new SystemMessageId(2440);
  /**
   * ID: 2441<br>
  ...
  public static final SystemMessageId ONLY_PARTY_LEADER_CAN_REQUEST_TEAM_MATCH =
      new SystemMessageId(2441);
  /**
   * ID: 2442<br>
   * Message: The request cannot be made because the requirements have not been met. To participate
   * in a team match, you must first form a 3-member party.
   */
  ...
  /**
   * ID: 2449<br>
   * Message: There are $s1 days remaining until your birthday. On your birthday, you will receive a
   * gift that Alegria has carefully prepared.
   */
  public static final SystemMessageId THERE_ARE_S1_DAYS_UNTIL_YOUR_CHARACTERS_BIRTHDAY =
      new SystemMessageId(2449);
  /**
   * ID: 2450<br>
  ...
  public static final SystemMessageId THE_AIRSHIP_NEED_CLANLVL_5_TO_SUMMON =
      new SystemMessageId(2456);
  /**
   * ID: 2457<br>
   * Message: An airship cannot be summoned because either you have not registered your airship
   * license, or the airship has not yet been summoned.
   */
  public static final SystemMessageId THE_AIRSHIP_NEED_LICENSE_TO_SUMMON =
      new SystemMessageId(2457);
  /**
   * ID: 2458<br>
  ...
  /**
   * ID: 2464<br>
   * Message: The airship's fuel (EP) has run out. The airship's speed will be greatly decreased in
   * this condition.
   */
  ...
  public static final SystemMessageId YOU_HAVE_USED_ALL_POINTS_POINTS_ARE_RESET_AT_NOON =
      new SystemMessageId(2469);
  /**
   * ID: 2470<br>
   * Message: This character cannot make a report. You cannot make a report while located inside a
   * peace zone or a battlefield, while you are an opposing clan member during a clan war, or while
   * participating in the Olympiad.
   */
  public static final SystemMessageId
      TARGET_NOT_REPORT_CANNOT_REPORT_PEACE_PVP_ZONE_OR_OLYMPIAD_OR_CLAN_WAR_ENEMY =
          new SystemMessageId(2470);
  /**
   * ID: 2471<br>
   * Message: This character cannot make a report. The target has already been reported by either
   * your clan or alliance, or has already been reported from your current IP.
   */
  public static final SystemMessageId
      CANNOT_REPORT_TARGET_ALREDY_REPORTED_BY_CLAN_ALLY_MEMBER_OR_SAME_IP =
          new SystemMessageId(2471);
  /**
   * ID: 2472<br>
   * Message: This character cannot make a report because another character from this account has
   * already done so.
   */
  public static final SystemMessageId CANNOT_REPORT_ALREDY_REPORED_FROM_THIS_ACCOUNT =
      new SystemMessageId(2472);
  /**
   * ID: 2473<br>
   * Message: You have been reported as an illegal program user, so your chatting will be blocked
   * for 10 minutes.
   */
  public static final SystemMessageId YOU_HAVE_BEEN_REPORTED_10_MIN_CHAT_BLOCKED =
      new SystemMessageId(2473);
  /**
   * ID: 2474<br>
   * Message: You have been reported as an illegal program user, so your party participation will be
   * blocked for 60 minutes.
   */
  public static final SystemMessageId YOU_HAVE_BEEN_REPORTED_60_MIN_PARTY_BLOCKED =
      new SystemMessageId(2474);
  /**
   * ID: 2475<br>
   * Message: You have been reported as an illegal program user, so your party participation will be
   * blocked for 120 minutes.
   */
  public static final SystemMessageId YOU_HAVE_BEEN_REPORTED_120_MIN_PARTY_BLOCKED =
      new SystemMessageId(2475);
  /**
   * ID: 2476<br>
   * Message: You have been reported as an illegal program user, so your party participation will be
   * blocked for 180 minutes.
   */
  public static final SystemMessageId YOU_HAVE_BEEN_REPORTED_180_MIN_PARTY_BLOCKED =
      new SystemMessageId(2476);
  /**
   * ID: 2477<br>
   * Message: You have been reported as an illegal program user, so your actions will be restricted
   * for 120 minutes.
   */
  public static final SystemMessageId YOU_HAVE_BEEN_REPORTED_120_MIN_ACTION_BLOCKED =
      new SystemMessageId(2477);
  /**
   * ID: 2478<br>
   * Message: You have been reported as an illegal program user, so your actions will be restricted
   * for 180 minutes.
  ...
  public static final SystemMessageId YOU_HAVE_BEEN_REPORTED_180_MIN_ACTION_BLOCKED_2 =
      new SystemMessageId(2479);
  /**
   * ID: 2480<br>
   * Message: You have been reported as an illegal program user, so movement is prohibited for 120
   * minutes.
   */
  public static final SystemMessageId YOU_HAVE_BEEN_REPORTED_120_MIN_MOVEMENT_BLOCKED =
      new SystemMessageId(2480);
  /**
   * ID: 2481<br>
  ...
  public static final SystemMessageId YOU_HAVE_BEEN_REPORTED_SO_CHATTING_NOT_ALLOWED =
      new SystemMessageId(2483);
  /**
   * ID: 2484<br>
   * Message: You have been reported as an illegal program user, so participating in a party is not
   * allowed.
   */
  public static final SystemMessageId YOU_HAVE_BEEN_REPORTED_SO_PARTY_NOT_ALLOWED =
      new SystemMessageId(2484);
  /**
   * ID: 2485<br>
   * Message: You have been reported as an illegal program user so your actions have been
   * restricted.
   */
  public static final SystemMessageId YOU_HAVE_BEEN_REPORTED_SO_ACTIONS_NOT_ALLOWED =
      new SystemMessageId(2485);
  /**
   * ID: 2486<br>
   * Message: You have been blocked due to verification that you are using a third party program.
   * Subsequent violations may result in termination of your account rather than a penalty within
   * the game.
   */
  public static final SystemMessageId
      YOU_HAVE_BEEN_BLOCKED_SUBSEQUENT_VIOLATIONS_RESULT_ACCOUNT_TERMINATION =
          new SystemMessageId(2486);
  /**
   * ID: 2487<br>
   * Message: You have been reported as an illegal program user, and your connection has been ended.
   * Please contact our CS team to confirm your identity.
   */
  public static final SystemMessageId YOU_HAVE_BEEN_REPORTED_AS_BOT_CONTACT_OUR_CS_TEAM =
      new SystemMessageId(2487);
  /**
   * ID: 2491<br>
  ...
  public static final SystemMessageId CANNOT_REGISTER_PROCESSING_CURSED_WEAPON =
      new SystemMessageId(2708);
  /**
   * ID: 2709<br>
   * Message: Applicants for the Olympiad, Underground Coliseum, or Kratei's Cube matches cannot
   * register.
   */
  public static final SystemMessageId COLISEUM_OLYMPIAD_KRATEIS_APPLICANTS_CANNOT_PARTICIPATE =
      new SystemMessageId(2709);
  /**
   * ID: 2710<br>
  ...
  /**
   * ID: 2720<br>
   * Message: Instant zone: $s1's entry has been restricted. You can check the next possible entry
   * time by using the command "/instancezone."
   */
  public static final SystemMessageId INSTANT_ZONE_FROM_HERE_S1_S_ENTRY_HAS_BEEN_RESTRICTED =
      new SystemMessageId(2720);
  /**
   * ID: 2721<br>
  ...
  /**
   * ID: 2764<br>
   * Message: You cannot enter because the corresponding alliance channel's maximum number of
   * entrants has been reached.
   */
  public static final SystemMessageId YOU_CANNOT_ENTER_BECAUSE_MAXIMUM_ENTRANTS =
      new SystemMessageId(2764);
  /**
   * ID: 2765<br>
  ...
  public static final SystemMessageId SEED_OF_DESTRUCTION_DEFENSE_IN_PROGRESS =
      new SystemMessageId(2773);
  /**
   * ID: 2774<br>
   * Message: You can make another report in $s1-minute(s). You have $s2 points remaining on this
   * account.
   */
  public static final SystemMessageId YOU_CAN_REPORT_IN_S1_MINS_YOU_HAVE_S2_POINTS_LEFT =
      new SystemMessageId(2774);
  /**
   * ID: 2777<br>
  ...
  public static final SystemMessageId YOU_CANNOT_TELEPORT_WHILE_IN_POSSESSION_OF_A_WARD =
      new SystemMessageId(2778);
  /**
   * ID: 2793<br>
   * Message: You must have a minimum of ($s1) people to enter this Instant Zone. Your request for
   * entry is denied.
   */
  public static final SystemMessageId YOU_MUST_HAVE_MINIMUM_OF_S1_PEOPLE_TO_ENTER =
      new SystemMessageId(2793);
  /**
   * ID: 2795<br>
  ...
  public static final SystemMessageId YOU_ALREADY_REQUESTED_TW_REGISTRATION =
      new SystemMessageId(2795);
  /**
   * ID: 2796<br>
   * Message: The clan who owns the territory cannot participate in the territory war as
   * mercenaries.
   */
  public static final SystemMessageId THE_TERRITORY_OWNER_CLAN_CANNOT_PARTICIPATE_AS_MERCENARIES =
      new SystemMessageId(2796);
  /**
   * ID: 2797<br>
   * Message: It is not a territory war registration period, so a request cannot be made at this
   * time.
   */
  ...
  public static final SystemMessageId CLAN_S1_HAS_SUCCEDED_IN_CAPTURING_S2_TERRITORY_WARD =
      new SystemMessageId(2913);
  /**
   * ID: 2914<br>
   * Message: The territory war will begin in 20 minutes! Territory related functions (i.e.:
   * battlefield channel, Disguise Scrolls, Transformations, etc...) can now be used.
   */
  public static final SystemMessageId TERRITORY_WAR_BEGINS_IN_20_MINUTES =
      new SystemMessageId(2914);
  /**
   * ID: 2922<br>
  ...
  /**
   * ID: 2936<br>
   * Message: The disguise scroll cannot be used because it is meant for use in a different
   * territory.
   */
  public static final SystemMessageId THE_DISGUISE_SCROLL_MEANT_FOR_DIFFERENT_TERRITORY =
      new SystemMessageId(2936);
  /**
   * ID: 2937<br>
  ...
  public static final SystemMessageId TERRITORY_OWNING_CLAN_CANNOT_USE_DISGUISE_SCROLL =
      new SystemMessageId(2937);
  /**
   * ID: 2955<br>
   * Message: The territory war exclusive disguise and transformation can be used 20 minutes before
   * the start of the territory war to 10 minutes after its end.
   */
  public static final SystemMessageId TERRITORY_WAR_SCROLL_CAN_NOT_USED_NOW =
      new SystemMessageId(2955);
  /**
   * ID: 2961<br>
  ...
  /**
   * ID: 3002<br>
   * Message: When the recipient doesn't exist or the character has been deleted, sending mail is
   * not possible.
   */
  ...
  public static final SystemMessageId PAYMENT_OF_S1_ADENA_COMPLETED_BY_S2 =
      new SystemMessageId(3025);
  /**
   * ID: 3026<br>
   * Message: You cannot use the skill enhancing function on this level. You can use the
   * corresponding function on levels higher than 76Lv .
   */
  public static final SystemMessageId YOU_CANNOT_USE_SKILL_ENCHANT_ON_THIS_LEVEL =
      new SystemMessageId(3026);
  /**
   * ID: 3027<br>
   * Message: You cannot use the skill enhancing function in this class. You can use corresponding
   * function when completing the third class change.
   */
  public static final SystemMessageId YOU_CANNOT_USE_SKILL_ENCHANT_IN_THIS_CLASS =
      new SystemMessageId(3027);
  /**
   * ID: 3028<br>
   * Message: You cannot use the skill enhancing function in this class. You can use the skill
   * enhancing function under off-battle status, and cannot use the function while transforming,
   * battling and on-board.
   */
  public static final SystemMessageId YOU_CANNOT_USE_SKILL_ENCHANT_ATTACKING_TRANSFORMED_BOAT =
      new SystemMessageId(3028);
  /**
   * ID: 3029<br>
   ...
   */
  public static final SystemMessageId
      BY_USING_THE_SKILL_OF_EINHASAD_S_HOLY_SWORD_DEFEAT_THE_EVIL_LILIMS =
          new SystemMessageId(3031);
  /**
   * ID: 3033<br>
  ...
  public static final SystemMessageId MALE_GUARDS_CAN_DETECT_FEMALES_DONT =
      new SystemMessageId(3037);
  /**
   * ID: 3038<br>
   * Message: Female guards notice the disguises from far away better than the male guards do, so
   * beware.
   */
  public static final SystemMessageId FEMALE_GUARDS_NOTICE_BETTER_THAN_MALE =
      new SystemMessageId(3038);
  /**
   * ID: 3039<br>
  ...
  public static final SystemMessageId USING_EINHASAD_HOLY_WATER_TO_OPEN_DOOR =
      new SystemMessageId(3039);
  /**
   * ID: 3040<br>
   * Message: By using the Court Magician's Magic Staff, open the door on which the magician's
   * barrier is placed.
   */
  public static final SystemMessageId USING_COURT_MAGICIANS_STAFF_TO_OPEN_DOOR =
      new SystemMessageId(3040);
  /**
   * ID: 3059<br>
  ...
  /**
   * ID: 3077<br>
   * Message: The mail limit (240) of the opponent's character has been exceeded and this cannot be
   * forwarded.
   */
  ...
  /**
   * ID: 3079<br>
   * Message: There are items in your Pet Inventory rendering you unable to sell/trade/drop pet
   * summoning items. Please empty your Pet Inventory.
   */
  ...
  public static final SystemMessageId CANNOT_RESET_SKILL_LINK_BECAUSE_NOT_ENOUGH_ADENA =
      new SystemMessageId(3080);
  /**
   * ID: 3081<br>
   * Message: You cannot receive it because you are under the condition that the opponent cannot
   * acquire any Adena for payment.
   */
  public static final SystemMessageId YOU_CANNOT_RECEIVE_CONDITION_OPPONENT_CANT_ACQUIRE_ADENA =
      new SystemMessageId(3081);
  /**
   * ID: 3082<br>
  ...
  public static final SystemMessageId YOU_CANNOT_SEND_MAIL_TO_CHAR_BLOCK_YOU =
      new SystemMessageId(3082);
  /**
   * ID: 3094<br>
   * Message: A user currently participating in the Olympiad cannot send party and friend
   * invitations.
   */
  public static final SystemMessageId
      A_USER_CURRENTLY_PARTICIPATING_IN_THE_OLYMPIAD_CANNOT_SEND_PARTY_AND_FRIEND_INVITATIONS =
          new SystemMessageId(3094);
  /**
   * ID: 3108<br>
  ...
  /**
   * ID: 3120<br>
   * Message: The request cannot be completed because the target does not meet location
   * requirements.
   */
  public static final SystemMessageId TARGET_DO_NOT_MEET_LOC_REQUIREMENTS =
      new SystemMessageId(3120);
  /**
   * ID: 3121<br>
  ...
  /**
   * ID: 3123<br>
   * Message: $c1 is in Private Shop mode or in a battle and cannot be requested for a couple
   * action.
   */
  public static final SystemMessageId
      C1_IS_IN_PRIVATE_SHOP_MODE_OR_IN_A_BATTLE_AND_CANNOT_BE_REQUESTED_FOR_A_COUPLE_ACTION =
          new SystemMessageId(3123);
  /**
   * ID: 3124<br>
  ...
  /**
   * ID: 3126<br>
   * Message: $c1 is already participating in a couple action and cannot be requested for another
   * couple action.
   */
  public static final SystemMessageId
      C1_IS_ALREADY_PARTICIPATING_IN_A_COUPLE_ACTION_AND_CANNOT_BE_REQUESTED_FOR_ANOTHER_COUPLE_ACTION =
          new SystemMessageId(3126);
  /**
   * ID: 3127<br>
  ...
  public static final SystemMessageId
      C1_IS_PARTICIPATING_IN_THE_OLYMPIAD_AND_CANNOT_BE_REQUESTED_FOR_A_COUPLE_ACTION =
          new SystemMessageId(3128);
  /**
   * ID: 3129<br>
   * Message: $c1 is participating in a hideout siege and cannot be requested for a couple action.
   */
  public static final SystemMessageId
      C1_IS_PARTICIPATING_IN_A_HIDEOUT_SIEGE_AND_CANNOT_BE_REQUESTED_FOR_A_COUPLE_ACTION =
          new SystemMessageId(3129);
  /**
   * ID: 3130<br>
  ...
  public static final SystemMessageId CLAN_CREST_WAS_SUCCESSFULLY_REGISTRED =
      new SystemMessageId(3140);
  /**
   * ID: 3144<br>
   * Message: The $s2's attribute was successfully bestowed on $s1, and resistance to $s3 was
   * increased.
   */
  public static final SystemMessageId
      THE_S2_ATTRIBUTE_WAS_SUCCESSFULLY_BESTOWED_ON_S1_RES_TO_S3_INCREASED =
          new SystemMessageId(3144);
  /**
   * ID: 3147<br>
   * Message: If you are not resurrected within $s1 minutes, you will be expelled from the instant
   * zone.
   */
  ...
  public static final SystemMessageId S1_S2_S3_ATTRIBUTE_REMOVED_RESISTANCE_TO_S4_DECREASED =
      new SystemMessageId(3160);
  /**
   * ID: 3163<br>
   * Message: The $s3's attribute was successfully bestowed on +$s1$s2, and resistance to $s4 was
   * increased.
   */
  public static final SystemMessageId
  ...
  public static final SystemMessageId WHEN_YOUR_PETS_HUNGER_GAUGE_IS_AT_0_YOU_CANNOT_USE_YOUR_PET =
      new SystemMessageId(3212);
  /**
   * ID: 3213<br>
   * Message: Your pet is starving and will not obey until it gets it's food. Feed your pet!
   */
  public static final SystemMessageId
      YOUR_PET_IS_STARVING_AND_WILL_NOT_OBEY_UNTIL_IT_GETS_ITS_FOOD_FEED_YOUR_PET =
          new SystemMessageId(3213);
  /**
   * ID: 3214<br>
  ...
  /**
   * ID: 3225<br>
   * Message: The total number of matches that can be entered in 1 week is 60 class irrelevant
   * individual matches, 30 specific matches, and 10 team matches.
   */
  public static final SystemMessageId
  ...
  /**
   * ID: 3261<br>
   * Message: You have $s1 match(es) remaining that you can participate in this week ($s2 1 vs 1
   * Class matches, $s3 1 vs 1 matches, & $s4 3 vs 3 Team matches).
   */
  public static final SystemMessageId
      YOU_HAVE_S1_MATCHES_REMAINING_THAT_YOU_CAN_PARTECIPATE_IN_THIS_WEEK_S2_CLASSED_S3_NON_CLASSED_S4_TEAM =
          new SystemMessageId(3261);
  /**
   * ID: 6004<br>
   ...
   */
  public static final SystemMessageId
      IF_YOU_HAVE_A_MAESTROS_KEY_YOU_CAN_USE_IT_TO_OPEN_THE_TREASURE_CHEST =
          new SystemMessageId(6050);
  /**
   * ID: 6501<br>
  ...
  public static void reloadLocalisations() {
    ...
    for (String lang : languages) {
      File file =
          new File(
              server().getDatapackRoot(),
              "data/lang/" + lang + "/sm/SystemMessageLocalisation.xml");
      if (!file.isFile()) {
        continue;
      }
  ...
  public static final class SMLocalisation {
    ...
    public String getLocalisation(final Object... params) {
