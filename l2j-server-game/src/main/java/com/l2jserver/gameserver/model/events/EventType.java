...
public enum EventType {
  ...
  private final List<Class<?>> returnClass;

  EventType(Class<? extends IBaseEvent> eventClass, Class<?> returnClasss) {
    this.eventClass = eventClass;
    returnClass = List.of(returnClasss);
  }

  EventType(Class<? extends IBaseEvent> eventClass, Class<?>... returnClasss) {
    this.eventClass = eventClass;
    returnClass = Arrays.asList(returnClasss);
  }
  ...
  public List<Class<?>> getReturnClasses() {
    return returnClass;
  }
  ...
  public boolean isReturnClass(Class<?> clazz) {
    return returnClass.contains(clazz);
  }
}
