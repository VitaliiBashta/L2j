...
public class Skill implements Identifiable {
	...
	private static final List<L2Object> EMPTY_TARGET_LIST = List.of();
	...
	public List<L2Object> getTargetList(L2Character activeChar) {
	...
	public void activateSkill(L2Character caster, L2Object targets) {
		activateSkill(caster, null, List.of(targets));
	}
	 ...
	 */
	public void activateSkill(L2Character caster, List<? extends L2Object> targets) {
	 ...
	 */
	public void activateSkill(L2CubicInstance cubic, List<? extends L2Object> targets) {
	 ...
	 * @param targets the targets
	 */
	private void activateSkill(L2Character caster, L2CubicInstance cubic, List<? extends L2Object> targets) {
		switch (getId()) {
