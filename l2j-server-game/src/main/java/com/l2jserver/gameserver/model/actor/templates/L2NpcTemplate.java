...
public class L2NpcTemplate extends L2CharTemplate implements Identifiable {
  ...
  public void setAISkillLists(Map<AISkillScope, List<Skill>> aiSkillLists) {
    _aiSkillLists =
        aiSkillLists != null ? Collections.unmodifiableMap(aiSkillLists) : Collections.emptyMap();
  }
   ...
   * @return {@code true} if at least one of the clan names belong to this NPC template clans,
  ...
  public void setIgnoreClanNpcIds(Set<Integer> ignoreClanNpcIds) {
    _ignoreClanNpcIds =
        ignoreClanNpcIds != null ? Collections.unmodifiableSet(ignoreClanNpcIds) : null;
  }
  ...
  public Collection<ItemHolder> calculateDrops(
      DropListScope dropListScope, L2Character victim, L2Character killer) {
