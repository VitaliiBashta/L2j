...
public class FortSiege implements Siegable {
	...
	public void endSiege() {
		if (isInProgress()) {
			...
			getSiegeGuardManager(null).unspawnSiegeGuard(); // Remove all spawned siege guard from this fort
	...
	private void spawnSiegeGuard() {
		getSiegeGuardManager(null).spawnSiegeGuard();
	}
	
	public final FortSiegeGuardManager getSiegeGuardManager(ConnectionFactory connectionFactory) {
		if (siegeGuardManager == null) {
			siegeGuardManager = new FortSiegeGuardManager(connectionFactory, fort);
		}
	...
	public class ScheduleEndSiegeTask implements Runnable {
		...
		public void run() {
			...
			try {
				...
				_log.log(Level.WARNING, "Exception: ScheduleEndSiegeTask() for Fort: " + fort.getName() + " " + e.getMessage(), e);
			}
		}
	}
	...
	public class ScheduleSuspiciousMerchantSpawn implements Runnable {
		...
		public void run() {
			...
			try {
				...
				_log.log(Level.WARNING, "Exception: ScheduleSuspicoiusMerchantSpawn() for Fort: " + fort.getName() + " " + e.getMessage(), e);
			}
		}
	}
	...
	public class ScheduleSiegeRestore implements Runnable {
		...
		public void run() {
			...
			try {
				...
				_log.log(Level.WARNING, "Exception: ScheduleSiegeRestore() for Fort: " + fort.getName() + " " + e.getMessage(), e);
			}
		}
	}
}
