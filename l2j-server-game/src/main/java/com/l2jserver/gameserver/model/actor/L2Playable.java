...
public abstract class L2Playable extends L2Character {
  ...
  public boolean doDie(L2Character killer) {
    final TerminateReturn returnBack =
        EventDispatcher.getInstance()
            .notifyEvent(new OnCreatureKill(killer, this), this, TerminateReturn.class);
  ...
  /**
   * For Newbie Protection Blessing skill, keeps you safe from an attack by a chaotic character >=
   * 10 levels apart from you.
   *
   * @return
   */
