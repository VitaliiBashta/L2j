...
public final class FreyaCelebration extends LongTimeEvent {
  ...
  private static final NpcStringId[] FREYA_TEXT = {
    ...
    NpcStringId
        .I_AM_ICE_QUEEN_FREYA_THIS_FEELING_AND_EMOTION_ARE_NOTHING_BUT_A_PART_OF_MELISSAA_MEMORIES
  };
      ...
      if (getRandom(100) < 5) {
        CreatureSay cs =
            new CreatureSay(
                ...
                npc.getName(),
                NpcStringId
                    .DEAR_S1_THINK_OF_THIS_AS_MY_APPRECIATION_FOR_THE_GIFT_TAKE_THIS_WITH_YOU_THERES_NOTHING_STRANGE_ABOUT_IT_ITS_JUST_A_BIT_OF_MY_CAPRICIOUSNESS);
        ...
        if (getRandom(10) < 2) {
          npc.broadcastPacket(
              new CreatureSay(
                  ...
                  Say2.NPC_ALL,
                  npc.getName(),
                  FREYA_TEXT[getRandom(FREYA_TEXT.length - 1)]));
        }
      }
    }
